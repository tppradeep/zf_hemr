...
// check permissions
$canEdit = $perms->checkModuleItem( 'dotp_task_log', 'edit', $task_id );
$canAdd = $perms->checkModuleItem( 'dotp_task_log', 'add', $task_id );
...
?>
		...
		<input type='hidden' name='email_task_list' id='email_task_list'
		  value='<?php
				...
				$q = new DBQuery;
				$q->addTable('dotp_task_contacts', 'tc');
				$q->leftJoin('dotp_contacts', 'c', 'c.contact_id = tc.contact_id');
...
?>'>
		...
		<input type='hidden' name='email_project_list' id='email_project_list'
		  value='<?php
				$q->clear();
				$q->addTable('dotp_project_contacts', 'pc');
				$q->leftJoin('dotp_contacts', 'c', 'c.contact_id = pc.contact_id');
