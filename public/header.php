...
<a hreflang="<?php echo $this->url(array('controller'=>'user','action'=>'index'),null,true);?>" class="header-home-logo"><img src="<?php echo $this->baseUrl();?>/images/home.png" alt="Home" /></a>
<?php 
    }
?>
