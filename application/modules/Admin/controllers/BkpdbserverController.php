...
class Admin_BkpdbserverController extends Zend_Controller_Action
{
    ...
    {
         $dbsdb = new Admin_Model_DbTable_Bkpdbserver();
	    ...
	    if ($this->getRequest()->isPost())
         {
             ...
             $this->_redirect('Admin/Bkpdbserver/index/st/1');
    ...
    public function editAction()
    {
    	$dbsdb=new Admin_Model_DbTable_Bkpdbserver();
         ...
         if ($this->getRequest()->isPost())
         {
             ...
             $this->_redirect('Admin/Bkpdbserver/index/st/2');
         }
         else
         {
    ...
    public function deleteAction()
    {
         ...
         $this->_redirect('Admin/Bkpdbserver/index/st/3');
    }
    ...
    public function deleteallAction()
    {
    	...
    	$delids = explode(",",$id);
	   	...
	   	$pss = new Admin_Model_DbTable_Bkpdbserver();
