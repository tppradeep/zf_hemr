...
CREATE TABLE IF NOT EXISTS `acl_user_setting` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=182 DEFAULT CHARSET=latin1 COMMENT='Controller and Action Section for a user';

-- Dumping data for table hosted_emr.acl_user_setting: ~96 rows (approximately)
...
INSERT INTO `acl_user_setting` (`id`, `hf_id`, `acl_resource`, `acl_action`) VALUES
	...
	(157, 248, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(158, 249, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(159, 250, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(160, 251, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(161, 252, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(162, 253, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(163, 254, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(164, 255, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(165, 256, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(166, 257, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(167, 258, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(168, 259, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(169, 260, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(170, 261, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(171, 262, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(172, 263, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(173, 264, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(174, 265, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(175, 266, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(176, 267, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(177, 268, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(178, 269, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(179, 270, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(180, 271, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20'),
	(181, 272, 'Profile,Changepassword,Plan,Products,Invoice,Backup', '18,17,16,13,15,14,11,19,20');
...
BEGIN
	DECLARE pcategory VARCHAR(50) DEFAULT "";
	DECLARE productname VARCHAR(150) DEFAULT "Product";
	DECLARE pcost FLOAT(20) DEFAULT 0.00;
	...
	SELECT category,product_name,cost,setup_fee,provider_cost_nature,provider_setup_nature INTO pcategory,productname,pcost,setupfee,providercostnature,providersetupnature FROM products WHERE idproducts=pid;
	...
	IF cartidcount = 0 THEN
		...
		INSERT INTO customer_products(hf_id,hp_id,idproducts,category,product_name,cost,setup_fee,product_status,additional) VALUES (hf_id,0,pid,pcategory,productname,uprice,setupfee,1,1);
...
-- Dumping structure for table hosted_emr.backup_db_server
DROP TABLE IF EXISTS `backup_db_server`;
CREATE TABLE IF NOT EXISTS `backup_db_server` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `db_name` varchar(255) NOT NULL,
  `status` tinyint(4) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `db_name` (`db_name`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=latin1 COMMENT='Back up Db Server Master Details';

-- Dumping data for table hosted_emr.backup_db_server: 1 rows
DELETE FROM `backup_db_server`;
/*!40000 ALTER TABLE `backup_db_server` DISABLE KEYS */;
INSERT INTO `backup_db_server` (`id`, `db_name`, `status`) VALUES
	(3, 'backup.hostedopenemr', 1);
/*!40000 ALTER TABLE `backup_db_server` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `cart` (
  ...
  PRIMARY KEY (`idcart`)
) ENGINE=InnoDB AUTO_INCREMENT=512 DEFAULT CHARSET=latin1 COMMENT='Shopping Cart';

-- Dumping data for table hosted_emr.cart: ~13 rows (approximately)
DELETE FROM `cart`;
...
INSERT INTO `cart` (`idcart`, `cartsession`, `plan_id`, `product_id`, `hf_id`, `description`, `qty_from`, `qty`, `unit_price`, `setupfee`, `discount`, `setupfee_discount`, `total`, `cstatus`, `cart_date`, `invoice_no`) VALUES
	(498, 'i0ns3h0ie6si7l833oo90osbo0', 15, 0, 249, 'ZH EMRRevenue Subscription', 0, 1, 285, 0, 11.4, 0, 273.6, 0, '2012-07-18', 'ZH-2012-07-18-00057'),
	(499, 'i0ns3h0ie6si7l833oo90osbo0', 0, 35, 249, 'Data Conversion', 0, 1, 0, 2000, 0, 0, 2000, 0, '2012-07-18', 'ZH-2012-07-18-00057'),
	(500, '99dr6786gfj6odi8g83biu6l77', 15, 0, 250, 'ZH EMRRevenue Subscription', 0, 1, 285, 0, 11.4, 0, 273.6, 0, '2012-07-18', 'ZH-2012-07-18-00060'),
	(501, '99dr6786gfj6odi8g83biu6l77', 0, 35, 250, 'Data Conversion', 0, 1, 0, 2000, 0, 0, 2000, 0, '2012-07-18', 'ZH-2012-07-18-00060'),
	(503, '99dr6786gfj6odi8g83biu6l77', 0, 31, 250, 'ZH Lab Interface', 0, 1, 50, 0, 0, 0, 50, 0, '2012-07-18', NULL),
	(504, '18r5idsb47tb3r2nul3rp9gcl1', 15, 0, 252, 'ZH EMRRevenue Subscription', 0, 2, 570, 0, 22.8, 0, 547.2, 0, '2012-07-18', 'ZH-2012-07-18-00062'),
	(505, 'm3m80p7t1s1vp7bck1jgft4p03', 15, 0, 253, 'ZH EMRRevenue Subscription', 0, 2, 570, 0, 22.8, 0, 547.2, 0, '2012-07-19', NULL),
	(506, 'cqg8bqa35i7fnns0bdh8hn3kv5', 15, 0, 254, 'ZH EMRRevenue Subscription', 0, 2, 570, 0, 22.8, 0, 547.2, 0, '2012-07-19', NULL),
	(507, 'vi8njkd5mec0kn3bcdj92m5d62', 15, 0, 258, 'ZH EMRRevenue Subscription', 0, 2, 570, 0, 22.8, 0, 547.2, 0, '2012-07-20', NULL),
	(508, 'vi8njkd5mec0kn3bcdj92m5d62', 15, 0, 258, 'ZH EMRRevenue Subscription', 0, 2, 570, 0, 22.8, 0, 547.2, 0, '2012-07-20', NULL),
	(509, '4i92a8v6s10e7l1254pa1a2f81', 15, 0, 259, 'ZH EMRRevenue Subscription', 0, 2, 570, 0, 22.8, 0, 547.2, 0, '2012-07-20', NULL),
	(510, 'kmkc64r0sjk4v1ehg4igookm26', 15, 0, 264, 'ZH EMRRevenue Subscription', 0, 2, 570, 0, 22.8, 0, 547.2, 0, '2012-07-23', NULL),
	(511, 'fu76b9vattougfitk67kq94qs4', 15, 0, 272, 'ZH EMRRevenue Subscription', 0, 2, 570, 0, 22.8, 0, 547.2, 0, '2012-07-23', NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=latin1 COMMENT='Invoice Details of Customers';

-- Dumping data for table hosted_emr.customer_invoice: ~8 rows (approximately)
...
INSERT INTO `customer_invoice` (`idcustomer_invoice`, `plan_id`, `hf_id`, `invoice_number`, `cartsessionid`, `particulars`, `amount`, `setupfee`, `payment_date`, `payment_status`, `transaction_id`, `status_message`, `invoice_date`, `paypal_string`, `subscription_amount`, `subscr_id`, `discount_percentage`, `discount_amount`, `activation_status`, `activation_message`) VALUES
	...
	(57, 15, 249, 'ZH-2012-07-18-00057', 'i0ns3h0ie6si7l833oo90osbo0', 'ZH EMRRevenue Subscription,Data Conversion', 273.6, 2000, NULL, 'Pending', '0', 'Pending', '2012-07-18', NULL, 273.6, NULL, 0, 11.4, 0, NULL),
	(60, 15, 250, 'ZH-2012-07-18-00060', '99dr6786gfj6odi8g83biu6l77', 'ZH EMRRevenue Subscription,Data Conversion', 273.6, 2000, NULL, 'Pending', '0', 'Pending', '2012-07-18', NULL, 273.6, NULL, 0, 11.4, 0, NULL),
	(61, 15, 250, 'ZH-2012-07-18-00061', '99dr6786gfj6odi8g83biu6l77', 'ZH Lab Interface', 50, 0, NULL, 'Pending', '0', 'Pending', '2012-07-18', NULL, 50, NULL, 0, 0, 0, NULL),
	(62, 15, 252, 'ZH-2012-07-18-00062', '18r5idsb47tb3r2nul3rp9gcl1', 'ZH EMRRevenue Subscription', 547.2, 0, NULL, 'Pending', '0', 'Pending', '2012-07-18', NULL, 547.2, NULL, 0, 22.8, 0, NULL),
	(63, 15, 258, 'ZH-2012-07-20-00063', 'vi8njkd5mec0kn3bcdj92m5d62', 'ZH EMRRevenue Subscription,ZH EMRRevenue Subscription', 1094.4, 0, NULL, 'Pending', '0', 'Pending', '2012-07-20', NULL, 1094.4, NULL, 0, 45.6, 0, NULL),
	(64, 15, 259, 'ZH-2012-07-20-00064', '4i92a8v6s10e7l1254pa1a2f81', 'ZH EMRRevenue Subscription', 547.2, 0, NULL, 'Pending', '0', 'Pending', '2012-07-20', NULL, 547.2, NULL, 0, 22.8, 0, NULL),
	(65, 15, 272, 'ZH-2012-07-23-00065', 'fu76b9vattougfitk67kq94qs4', 'ZH EMRRevenue Subscription', 547.2, 0, NULL, 'Pending', '0', 'Pending', '2012-07-23', NULL, 547.2, NULL, 0, 22.8, 0, NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=1009 DEFAULT CHARSET=latin1 COMMENT='Products Master Table';

-- Dumping data for table hosted_emr.customer_products: ~73 rows (approximately)
...
INSERT INTO `customer_products` (`idcustomer_products`, `hf_id`, `hp_id`, `idproducts`, `category`, `product_name`, `customer_id`, `product_feature`, `user_from`, `user_to`, `cost`, `setup_fee`, `payment_term`, `product_sort_order`, `product_status`, `Column 16`, `actual_cost`, `actual_setupfee`, `discount_provided_by`, `discount_given_date`, `ProductType`, `provider_cost_nature`, `provider_setup_nature`, `emrfeature`, `additional`) VALUES
	...
	(949, 248, 15, 1, 'product', 'ZH OpenEMR', '1', '<p>\r\n	Scheduling</p>\r\n<ul>\r\n	<li>\r\n		Supports multiple physicians and facilities</li>\r\n	<li>\r\n		Easy to manage appointment calendar</li>\r\n	<li>\r\n		Ability to assign olors to easily identify appointment types or facilities</li>\r\n	<li>\r\n		Supports repeating appointments and restricting appointments</li>\r\n	<li>\r\n		Supports patient reminders and notifications</li>\r\n	<li>\r\n		Physcian Reminders</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Patient Demographics</p>\r\n<ul>\r\n	<li>\r\n		Manage Patient Demographics</li>\r\n	<li>\r\n		Comprehensive patient identification profile information, including full name, date of birth, sex, identification, language, ethinicity, marital status</li>\r\n	<li>\r\n		Contact information for patient</li>\r\n	<li>\r\n		Emergency Contact information</li>\r\n	<li>\r\n		Employment Information</li>\r\n	<li>\r\n		Insurance Coverage</li>\r\n	<li>\r\n		Primary Provider</li>\r\n	<li>\r\n		HIPAA Information</li>\r\n	<li>\r\n		Fully Customizable to easily extend out of the box demographic profile</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Patient History</p>\r\n<ul>\r\n	<li>\r\n		Medical Issues</li>\r\n	<li>\r\n		Medications</li>\r\n	<li>\r\n		Immunizations</li>\r\n	<li>\r\n		Vitals</li>\r\n	<li>\r\n		Labs</li>\r\n	<li>\r\n		Procedures</li>\r\n	<li>\r\n		Clinical Decision Rules to check/monitor/alert clinical information (such as vitals, history information, medications, procedures, labs, etc.) in real time</li>\r\n	<li>\r\n		Clinical Measures Calculations</li>\r\n	<li>\r\n		Clinical Quality Measure Calculations</li>\r\n	<li>\r\n		Automated Measure Calculations (AMC) and Tracking</li>\r\n	<li>\r\n		Scan, link, and manage any document or picture</li>\r\n	<li>\r\n		Insurance Eligibility</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Encounters and Charting</p>\r\n<ul>\r\n	<li>\r\n		Fully customizable, template driven forms</li>\r\n	<li>\r\n		Comprehensive chart, visit summary, patient history views for quick updates</li>\r\n	<li>\r\n		Voice recognition ready</li>\r\n	<li>\r\n		Graphical Charting</li>\r\n	<li>\r\n		Easy to use Patient Notes with time savings features allowing saving of frequently used notes for reuse</li>\r\n	<li>\r\n		Diagnosis and procedure coding (CPT/ICD-9)</li>\r\n	<li>\r\n		Communications ready to create letters for insurance providers, referring physicians, or patients</li>\r\n	<li>\r\n		Electronic Syndrome Surveillance reporting</li>\r\n	<li>\r\n		Clinical Measures Calculations</li>\r\n	<li>\r\n		Clinical Quality Measure Calculations</li>\r\n	<li>\r\n		Automated Measure Calculations (AMC) and Tracking</li>\r\n	<li>\r\n		Hardcopy and eRX ready</li>\r\n	<li>\r\n		Paper Chart Tracking</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Billing and Receivables</p>\r\n<ul>\r\n	<li>\r\n		Flexible system of coding including CPT, HCPCS and ICD codes and the ability to add others</li>\r\n	<li>\r\n		Support for electronic billing to clearing houses such as Medavant/Capario and ZirMED using ANSI X12</li>\r\n	<li>\r\n		Support for paper claims</li>\r\n	<li>\r\n		Insurance Eligibility Queries</li>\r\n	<li>\r\n		Insurance Tracking Interface</li>\r\n	<li>\r\n		Accounts Receivable Interface</li>\r\n	<li>\r\n		Medical claim management interface</li>\r\n	<li>\r\n		EOB Entry Interface</li>\r\n	<li>\r\n		Customizable to work with a clearing house for automated 835 or ERA entry</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Additional Features</p>\r\n<ul>\r\n	<li>\r\n		Fully Customizable and Flexible to modify to how you work</li>\r\n	<li>\r\n		Supports use of multiple languages within the same clinic</li>\r\n	<li>\r\n		Robust reporting features with ability to create, enhance, and extend</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Certifications</p>\r\n<ul>\r\n	<li>\r\n		ONC Complete Ambulatory EHR Certified</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	<br />\r\n	Security</p>\r\n<ul>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ability to Encrypt Patient Documents</li>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Supports fine-grained per-user access controls</li>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Remotely accessible from any modern web browser with a suitable security certificate installed</li>\r\n</ul>\r\n', NULL, NULL, 75, 0, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(950, 248, 15, 36, 'product', 'ZH Patient Portal', '1', '<p>\r\n	ZH Patient Portal gives a direct online link between the provider and the patient to allow for easy resolution of questions, make it easier to complete required forms and overall provide a better service to your patients.</p>\r\n<ul>\r\n	<li>\r\n		Flexible and easily configurable to needs of each practice</li>\r\n	<li>\r\n		New patient can register online and complete pre-visit documents</li>\r\n	<li>\r\n		Patient can browse and make appointment online</li>\r\n	<li>\r\n		View and update patient profile inforamtion including demographic and insurance infomation</li>\r\n	<li>\r\n		Make payments online</li>\r\n	<li>\r\n		View medical records including lab results and presriptions</li>\r\n	<li>\r\n		View billing account and statements</li>\r\n	<li>\r\n		Communicate easily through a secure mailbox to request refills, referrals, or other information</li>\r\n</ul>\r\n', NULL, NULL, 0, 0, NULL, 2, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 1, '', 0),
	(951, 248, 15, 29, 'product', 'ZH Advanced Billing', '1', '<p>\r\n	The Advanced Billing module is focused on providing capabilities to manage and improve your revenue cycle by decreasing staff time needed to enter billing, process and manage insurance claims, record payments; improve the accuracy of coding of encounters; provide quick access to patient accounts for responding to inquiries and resolving status of claims.</p>\r\n<p>\r\n	<strong>Enhanced Billing and Claims Processing</strong></p>\r\n<p>\r\n	Smart Fee Sheet</p>\r\n<ul>\r\n	<li>\r\n		Easy to use template that looks like the paper superbill you are used to</li>\r\n	<li>\r\n		Store CPT, ICD valid codes for easy and correct entry</li>\r\n	<li>\r\n		Allows for multiple fee sheets for a single factility</li>\r\n	<li>\r\n		Allows advanced capaility to lock encounters that are not ready for billing</li>\r\n	<li>\r\n		Time saving ability to enter miscellaneous options without leaving the fee sheet</li>\r\n</ul>\r\n<p>\r\n	Batch Charge Entry to Support Larger Facilities</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter multiple claims from a single screen</li>\r\n	<li>\r\n		Allows for entry of new patients from the same screen</li>\r\n</ul>\r\n<p>\r\n	Real Time Eligibility Verification for Insurance</p>\r\n<p>\r\n	Billing Management</p>\r\n<ul>\r\n	<li>\r\n		Work on all claims from a single screen</li>\r\n	<li>\r\n		Advanced filters to see only the claims you are interested in working</li>\r\n	<li>\r\n		Allows to view fee sheet and demographics ledger</li>\r\n	<li>\r\n		Ability to fix all errors before submittal increasing First Pass Rate</li>\r\n	<li>\r\n		Data entry uses quality control verifying codes as you type and automatically applies relevant data (patient, provider, payer) from system database</li>\r\n	<li>\r\n		Generate HCFA, PDF, TXT, or Electronic Claims files</li>\r\n	<li>\r\n		Automatically generate and upload claims to clearing house</li>\r\n	<li>\r\n		Option to direct claims to 3rd party billing systems</li>\r\n	<li>\r\n		Supports multiple insurance company networks</li>\r\n	<li>\r\n		Ability to process secondary insurance claims</li>\r\n	<li>\r\n		Ability to write off balances</li>\r\n	<li>\r\n		Allows for moving balances to patient accounts</li>\r\n	<li>\r\n		Ability to send more than 4 diagnosis with claim</li>\r\n</ul>\r\n<p>\r\n	Clearing House Integration</p>\r\n<ul>\r\n	<li>\r\n		Seamless integration avoiding steps to generate and upload files separately</li>\r\n	<li>\r\n		Advanced import facility will import NPI and Tax ID numbers needed for posting payment from ERA</li>\r\n	<li>\r\n		Enhanced file summary of uploaded claimes to clearing house includes current status of the claims and response from the payer allowing ability to update the EMR database automatically</li>\r\n</ul>\r\n<p>\r\n	Rejected Claim Management</p>\r\n<ul>\r\n	<li>\r\n		Enhanced query ability to enable quick review to remedy errors and refile claims from a sign screen</li>\r\n	<li>\r\n		Stores history relating to why the claims were denied</li>\r\n</ul>\r\n<p>\r\n	<strong>Advanced Payment Receipt Processing</strong></p>\r\n<p>\r\n	Payments</p>\r\n<ul>\r\n	<li>\r\n		Easy entry of payments and adjustments</li>\r\n	<li>\r\n		Single screen to receive any payment method including cash, check, credit card</li>\r\n	<li>\r\n		Advanced search and filtering to view only the payments you wish to review</li>\r\n	<li>\r\n		Allows receipt from any type of payment source including advance payment, group payment, capitation payment, insurance payment</li>\r\n	<li>\r\n		Easily allocate payment or EOBs to specific encounters</li>\r\n	<li>\r\n		Easily allocate payment to specific CPTs within a claim and track unpaid CPTs within a claim</li>\r\n	<li>\r\n		Ability to enter payments to specific &quot;post to&quot; dates</li>\r\n	<li>\r\n		Easily enter data from EOBs and apply insurance company responses to patient accounts</li>\r\n	<li>\r\n		View and print original EOBs and other payment documents</li>\r\n</ul>\r\n<p>\r\n	ERA&nbsp; Posting</p>\r\n<ul>\r\n	<li>\r\n		Post individual ERA and automatically update to patient accounts</li>\r\n	<li>\r\n		Advanced ability to batch process ERA files from multiple insurance companies greatly reducing process time for larger facilities</li>\r\n</ul>\r\n<p>\r\n	Capitation Payments</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter and track capitation payments</li>\r\n	<li>\r\n		Analysis reporting for profitability of capitated patient encounters</li>\r\n</ul>\r\n<p>\r\n	<strong>Accounts Receivable Management</strong></p>\r\n<ul>\r\n	<li>\r\n		Full featured claims and action tracking allowing to monitor and report on claim status, alert for followups, and identify payer denied claims</li>\r\n	<li>\r\n		Supports claims appeal process to determine reason for denial, collection of needed additional information and resubmission of claim</li>\r\n	<li>\r\n		Maintains call log of followup actions</li>\r\n</ul>\r\n<p>\r\n	<strong>Patient Accounts</strong></p>\r\n<p>\r\n	Pre-Authorization Management</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter pre-autorization and plan details greatly reducing staff time needed to manage the variations of authorized treatment</li>\r\n	<li>\r\n		Track encounters based on number of visits, hours, specific CPTs</li>\r\n	<li>\r\n		Flag encounters where pre-autorization is not covered or reaches allowed coverage</li>\r\n</ul>\r\n<p>\r\n	Patient Ledger</p>\r\n<ul>\r\n	<li>\r\n		Elaborate patient ledger displaying total charges, amounts pending for each insurance, payments received, balance details detailing insurance versus patient portion</li>\r\n	<li>\r\n		Color coded line items to easily distingish services, patient payments, insurance payments, and adjustments</li>\r\n	<li>\r\n		One click viewing of underlying fee sheet or payment</li>\r\n	<li>\r\n		Quick printing directly from ledger of individual patient statement and patient ledger</li>\r\n</ul>\r\n<p>\r\n	Patient Statements</p>\r\n<ul>\r\n	<li>\r\n		Batch or individual printing of billing statements</li>\r\n	<li>\r\n		Quick access to billing statement and payment history from patient profile</li>\r\n	<li>\r\n		Easy billing lookup for responding to patient billing inquiries</li>\r\n</ul>\r\n<p>\r\n	<strong>Advanced Reporting</strong></p>\r\n<ul>\r\n	<li>\r\n		Library of reports to track accounts receivable, patients, and other financial information</li>\r\n	<li>\r\n		Ability to customize reports to needs</li>\r\n	<li>\r\n		Reporting memory option allowing specific filter and reporting queries to be saved for repeated use</li>\r\n	<li>\r\n		Export reports to PDF, Excel or CSV formats</li>\r\n</ul>\r\n', NULL, NULL, 75, 0, NULL, 3, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(952, 248, 15, 30, 'product', 'ZH eRx', '1', '<p>\r\n	ZHOpenEMR&rsquo;s electronic prescription or e-Prescription module enables your practice to facilitate faster delivery of medicines, refills, with accuracy. &nbsp;</p>\r\n<ul>\r\n	<li>\r\n		Submit electronic presriptions to any pharmacy</li>\r\n	<li>\r\n		Supports refill requests</li>\r\n	<li>\r\n		Includes drug-drug and drug-allergy interactions</li>\r\n	<li>\r\n		Allows ability to also print presriptions</li>\r\n	<li>\r\n		Available as a standalone product</li>\r\n</ul>\r\n', NULL, NULL, 35, 0, NULL, 4, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(953, 248, 15, 33, 'support', ' Preferred Support', '1', '<p>\r\n	Our most popular plan provides you with your reliable, always on, always up to date system as well as access to our customer care experts for addressing your technical and ZH OpenEMR software usage questions.</p>\r\n<p>\r\n	Plan Details:</p>\r\n<ul>\r\n	<li>\r\n		$100 per month per provider</li>\r\n	<li>\r\n		Unlimited Support Requests (Incidents)</li>\r\n	<li>\r\n		1 Named Contact&nbsp;&nbsp; &nbsp;&nbsp;</li>\r\n	<li>\r\n		Resolution for ZH -owned issues</li>\r\n	<li>\r\n		Support during Local business hours</li>\r\n	<li>\r\n		12 hour Initial Response Time</li>\r\n	<li>\r\n		Web Case Management</li>\r\n	<li>\r\n		Email Support</li>\r\n	<li>\r\n		One-on-one online support</li>\r\n	<li>\r\n		One-on-one phone support</li>\r\n	<li>\r\n		Remote Troubleshooting&nbsp; &nbsp;&nbsp;</li>\r\n	<li>\r\n		Best practice guidance</li>\r\n	<li>\r\n		Go-Live Assistance</li>\r\n	<li>\r\n		Scheduled Upgrade Assistance</li>\r\n	<li>\r\n		Self Help Support including:&nbsp; &nbsp; &nbsp;&nbsp;\r\n		<ul>\r\n			<li>\r\n				Account Portal</li>\r\n			<li>\r\n				Access to User Manuals</li>\r\n			<li>\r\n				Access to online tutorial videos</li>\r\n			<li>\r\n				Best Practice Knowledge Base</li>\r\n			<li>\r\n				User Forums</li>\r\n		</ul>\r\n	</li>\r\n</ul>\r\n', NULL, NULL, 100, 0, NULL, 7, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(954, 248, 0, 31, 'product', 'ZH Lab Interface', NULL, NULL, NULL, NULL, 100, 0, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, '', 1),
	(955, 249, 15, 1, 'product', 'ZH OpenEMR', '1', '<p>\r\n	Scheduling</p>\r\n<ul>\r\n	<li>\r\n		Supports multiple physicians and facilities</li>\r\n	<li>\r\n		Easy to manage appointment calendar</li>\r\n	<li>\r\n		Ability to assign olors to easily identify appointment types or facilities</li>\r\n	<li>\r\n		Supports repeating appointments and restricting appointments</li>\r\n	<li>\r\n		Supports patient reminders and notifications</li>\r\n	<li>\r\n		Physcian Reminders</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Patient Demographics</p>\r\n<ul>\r\n	<li>\r\n		Manage Patient Demographics</li>\r\n	<li>\r\n		Comprehensive patient identification profile information, including full name, date of birth, sex, identification, language, ethinicity, marital status</li>\r\n	<li>\r\n		Contact information for patient</li>\r\n	<li>\r\n		Emergency Contact information</li>\r\n	<li>\r\n		Employment Information</li>\r\n	<li>\r\n		Insurance Coverage</li>\r\n	<li>\r\n		Primary Provider</li>\r\n	<li>\r\n		HIPAA Information</li>\r\n	<li>\r\n		Fully Customizable to easily extend out of the box demographic profile</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Patient History</p>\r\n<ul>\r\n	<li>\r\n		Medical Issues</li>\r\n	<li>\r\n		Medications</li>\r\n	<li>\r\n		Immunizations</li>\r\n	<li>\r\n		Vitals</li>\r\n	<li>\r\n		Labs</li>\r\n	<li>\r\n		Procedures</li>\r\n	<li>\r\n		Clinical Decision Rules to check/monitor/alert clinical information (such as vitals, history information, medications, procedures, labs, etc.) in real time</li>\r\n	<li>\r\n		Clinical Measures Calculations</li>\r\n	<li>\r\n		Clinical Quality Measure Calculations</li>\r\n	<li>\r\n		Automated Measure Calculations (AMC) and Tracking</li>\r\n	<li>\r\n		Scan, link, and manage any document or picture</li>\r\n	<li>\r\n		Insurance Eligibility</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Encounters and Charting</p>\r\n<ul>\r\n	<li>\r\n		Fully customizable, template driven forms</li>\r\n	<li>\r\n		Comprehensive chart, visit summary, patient history views for quick updates</li>\r\n	<li>\r\n		Voice recognition ready</li>\r\n	<li>\r\n		Graphical Charting</li>\r\n	<li>\r\n		Easy to use Patient Notes with time savings features allowing saving of frequently used notes for reuse</li>\r\n	<li>\r\n		Diagnosis and procedure coding (CPT/ICD-9)</li>\r\n	<li>\r\n		Communications ready to create letters for insurance providers, referring physicians, or patients</li>\r\n	<li>\r\n		Electronic Syndrome Surveillance reporting</li>\r\n	<li>\r\n		Clinical Measures Calculations</li>\r\n	<li>\r\n		Clinical Quality Measure Calculations</li>\r\n	<li>\r\n		Automated Measure Calculations (AMC) and Tracking</li>\r\n	<li>\r\n		Hardcopy and eRX ready</li>\r\n	<li>\r\n		Paper Chart Tracking</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Billing and Receivables</p>\r\n<ul>\r\n	<li>\r\n		Flexible system of coding including CPT, HCPCS and ICD codes and the ability to add others</li>\r\n	<li>\r\n		Support for electronic billing to clearing houses such as Medavant/Capario and ZirMED using ANSI X12</li>\r\n	<li>\r\n		Support for paper claims</li>\r\n	<li>\r\n		Insurance Eligibility Queries</li>\r\n	<li>\r\n		Insurance Tracking Interface</li>\r\n	<li>\r\n		Accounts Receivable Interface</li>\r\n	<li>\r\n		Medical claim management interface</li>\r\n	<li>\r\n		EOB Entry Interface</li>\r\n	<li>\r\n		Customizable to work with a clearing house for automated 835 or ERA entry</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Additional Features</p>\r\n<ul>\r\n	<li>\r\n		Fully Customizable and Flexible to modify to how you work</li>\r\n	<li>\r\n		Supports use of multiple languages within the same clinic</li>\r\n	<li>\r\n		Robust reporting features with ability to create, enhance, and extend</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Certifications</p>\r\n<ul>\r\n	<li>\r\n		ONC Complete Ambulatory EHR Certified</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	<br />\r\n	Security</p>\r\n<ul>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ability to Encrypt Patient Documents</li>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Supports fine-grained per-user access controls</li>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Remotely accessible from any modern web browser with a suitable security certificate installed</li>\r\n</ul>\r\n', NULL, NULL, 75, 0, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(956, 249, 15, 36, 'product', 'ZH Patient Portal', '1', '<p>\r\n	ZH Patient Portal gives a direct online link between the provider and the patient to allow for easy resolution of questions, make it easier to complete required forms and overall provide a better service to your patients.</p>\r\n<ul>\r\n	<li>\r\n		Flexible and easily configurable to needs of each practice</li>\r\n	<li>\r\n		New patient can register online and complete pre-visit documents</li>\r\n	<li>\r\n		Patient can browse and make appointment online</li>\r\n	<li>\r\n		View and update patient profile inforamtion including demographic and insurance infomation</li>\r\n	<li>\r\n		Make payments online</li>\r\n	<li>\r\n		View medical records including lab results and presriptions</li>\r\n	<li>\r\n		View billing account and statements</li>\r\n	<li>\r\n		Communicate easily through a secure mailbox to request refills, referrals, or other information</li>\r\n</ul>\r\n', NULL, NULL, 0, 0, NULL, 2, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 1, '', 0),
	(957, 249, 15, 29, 'product', 'ZH Advanced Billing', '1', '<p>\r\n	The Advanced Billing module is focused on providing capabilities to manage and improve your revenue cycle by decreasing staff time needed to enter billing, process and manage insurance claims, record payments; improve the accuracy of coding of encounters; provide quick access to patient accounts for responding to inquiries and resolving status of claims.</p>\r\n<p>\r\n	<strong>Enhanced Billing and Claims Processing</strong></p>\r\n<p>\r\n	Smart Fee Sheet</p>\r\n<ul>\r\n	<li>\r\n		Easy to use template that looks like the paper superbill you are used to</li>\r\n	<li>\r\n		Store CPT, ICD valid codes for easy and correct entry</li>\r\n	<li>\r\n		Allows for multiple fee sheets for a single factility</li>\r\n	<li>\r\n		Allows advanced capaility to lock encounters that are not ready for billing</li>\r\n	<li>\r\n		Time saving ability to enter miscellaneous options without leaving the fee sheet</li>\r\n</ul>\r\n<p>\r\n	Batch Charge Entry to Support Larger Facilities</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter multiple claims from a single screen</li>\r\n	<li>\r\n		Allows for entry of new patients from the same screen</li>\r\n</ul>\r\n<p>\r\n	Real Time Eligibility Verification for Insurance</p>\r\n<p>\r\n	Billing Management</p>\r\n<ul>\r\n	<li>\r\n		Work on all claims from a single screen</li>\r\n	<li>\r\n		Advanced filters to see only the claims you are interested in working</li>\r\n	<li>\r\n		Allows to view fee sheet and demographics ledger</li>\r\n	<li>\r\n		Ability to fix all errors before submittal increasing First Pass Rate</li>\r\n	<li>\r\n		Data entry uses quality control verifying codes as you type and automatically applies relevant data (patient, provider, payer) from system database</li>\r\n	<li>\r\n		Generate HCFA, PDF, TXT, or Electronic Claims files</li>\r\n	<li>\r\n		Automatically generate and upload claims to clearing house</li>\r\n	<li>\r\n		Option to direct claims to 3rd party billing systems</li>\r\n	<li>\r\n		Supports multiple insurance company networks</li>\r\n	<li>\r\n		Ability to process secondary insurance claims</li>\r\n	<li>\r\n		Ability to write off balances</li>\r\n	<li>\r\n		Allows for moving balances to patient accounts</li>\r\n	<li>\r\n		Ability to send more than 4 diagnosis with claim</li>\r\n</ul>\r\n<p>\r\n	Clearing House Integration</p>\r\n<ul>\r\n	<li>\r\n		Seamless integration avoiding steps to generate and upload files separately</li>\r\n	<li>\r\n		Advanced import facility will import NPI and Tax ID numbers needed for posting payment from ERA</li>\r\n	<li>\r\n		Enhanced file summary of uploaded claimes to clearing house includes current status of the claims and response from the payer allowing ability to update the EMR database automatically</li>\r\n</ul>\r\n<p>\r\n	Rejected Claim Management</p>\r\n<ul>\r\n	<li>\r\n		Enhanced query ability to enable quick review to remedy errors and refile claims from a sign screen</li>\r\n	<li>\r\n		Stores history relating to why the claims were denied</li>\r\n</ul>\r\n<p>\r\n	<strong>Advanced Payment Receipt Processing</strong></p>\r\n<p>\r\n	Payments</p>\r\n<ul>\r\n	<li>\r\n		Easy entry of payments and adjustments</li>\r\n	<li>\r\n		Single screen to receive any payment method including cash, check, credit card</li>\r\n	<li>\r\n		Advanced search and filtering to view only the payments you wish to review</li>\r\n	<li>\r\n		Allows receipt from any type of payment source including advance payment, group payment, capitation payment, insurance payment</li>\r\n	<li>\r\n		Easily allocate payment or EOBs to specific encounters</li>\r\n	<li>\r\n		Easily allocate payment to specific CPTs within a claim and track unpaid CPTs within a claim</li>\r\n	<li>\r\n		Ability to enter payments to specific &quot;post to&quot; dates</li>\r\n	<li>\r\n		Easily enter data from EOBs and apply insurance company responses to patient accounts</li>\r\n	<li>\r\n		View and print original EOBs and other payment documents</li>\r\n</ul>\r\n<p>\r\n	ERA&nbsp; Posting</p>\r\n<ul>\r\n	<li>\r\n		Post individual ERA and automatically update to patient accounts</li>\r\n	<li>\r\n		Advanced ability to batch process ERA files from multiple insurance companies greatly reducing process time for larger facilities</li>\r\n</ul>\r\n<p>\r\n	Capitation Payments</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter and track capitation payments</li>\r\n	<li>\r\n		Analysis reporting for profitability of capitated patient encounters</li>\r\n</ul>\r\n<p>\r\n	<strong>Accounts Receivable Management</strong></p>\r\n<ul>\r\n	<li>\r\n		Full featured claims and action tracking allowing to monitor and report on claim status, alert for followups, and identify payer denied claims</li>\r\n	<li>\r\n		Supports claims appeal process to determine reason for denial, collection of needed additional information and resubmission of claim</li>\r\n	<li>\r\n		Maintains call log of followup actions</li>\r\n</ul>\r\n<p>\r\n	<strong>Patient Accounts</strong></p>\r\n<p>\r\n	Pre-Authorization Management</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter pre-autorization and plan details greatly reducing staff time needed to manage the variations of authorized treatment</li>\r\n	<li>\r\n		Track encounters based on number of visits, hours, specific CPTs</li>\r\n	<li>\r\n		Flag encounters where pre-autorization is not covered or reaches allowed coverage</li>\r\n</ul>\r\n<p>\r\n	Patient Ledger</p>\r\n<ul>\r\n	<li>\r\n		Elaborate patient ledger displaying total charges, amounts pending for each insurance, payments received, balance details detailing insurance versus patient portion</li>\r\n	<li>\r\n		Color coded line items to easily distingish services, patient payments, insurance payments, and adjustments</li>\r\n	<li>\r\n		One click viewing of underlying fee sheet or payment</li>\r\n	<li>\r\n		Quick printing directly from ledger of individual patient statement and patient ledger</li>\r\n</ul>\r\n<p>\r\n	Patient Statements</p>\r\n<ul>\r\n	<li>\r\n		Batch or individual printing of billing statements</li>\r\n	<li>\r\n		Quick access to billing statement and payment history from patient profile</li>\r\n	<li>\r\n		Easy billing lookup for responding to patient billing inquiries</li>\r\n</ul>\r\n<p>\r\n	<strong>Advanced Reporting</strong></p>\r\n<ul>\r\n	<li>\r\n		Library of reports to track accounts receivable, patients, and other financial information</li>\r\n	<li>\r\n		Ability to customize reports to needs</li>\r\n	<li>\r\n		Reporting memory option allowing specific filter and reporting queries to be saved for repeated use</li>\r\n	<li>\r\n		Export reports to PDF, Excel or CSV formats</li>\r\n</ul>\r\n', NULL, NULL, 75, 0, NULL, 3, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(958, 249, 15, 30, 'product', 'ZH eRx', '1', '<p>\r\n	ZHOpenEMR&rsquo;s electronic prescription or e-Prescription module enables your practice to facilitate faster delivery of medicines, refills, with accuracy. &nbsp;</p>\r\n<ul>\r\n	<li>\r\n		Submit electronic presriptions to any pharmacy</li>\r\n	<li>\r\n		Supports refill requests</li>\r\n	<li>\r\n		Includes drug-drug and drug-allergy interactions</li>\r\n	<li>\r\n		Allows ability to also print presriptions</li>\r\n	<li>\r\n		Available as a standalone product</li>\r\n</ul>\r\n', NULL, NULL, 35, 0, NULL, 4, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(959, 249, 15, 33, 'support', ' Preferred Support', '1', '<p>\r\n	Our most popular plan provides you with your reliable, always on, always up to date system as well as access to our customer care experts for addressing your technical and ZH OpenEMR software usage questions.</p>\r\n<p>\r\n	Plan Details:</p>\r\n<ul>\r\n	<li>\r\n		$100 per month per provider</li>\r\n	<li>\r\n		Unlimited Support Requests (Incidents)</li>\r\n	<li>\r\n		1 Named Contact&nbsp;&nbsp; &nbsp;&nbsp;</li>\r\n	<li>\r\n		Resolution for ZH -owned issues</li>\r\n	<li>\r\n		Support during Local business hours</li>\r\n	<li>\r\n		12 hour Initial Response Time</li>\r\n	<li>\r\n		Web Case Management</li>\r\n	<li>\r\n		Email Support</li>\r\n	<li>\r\n		One-on-one online support</li>\r\n	<li>\r\n		One-on-one phone support</li>\r\n	<li>\r\n		Remote Troubleshooting&nbsp; &nbsp;&nbsp;</li>\r\n	<li>\r\n		Best practice guidance</li>\r\n	<li>\r\n		Go-Live Assistance</li>\r\n	<li>\r\n		Scheduled Upgrade Assistance</li>\r\n	<li>\r\n		Self Help Support including:&nbsp; &nbsp; &nbsp;&nbsp;\r\n		<ul>\r\n			<li>\r\n				Account Portal</li>\r\n			<li>\r\n				Access to User Manuals</li>\r\n			<li>\r\n				Access to online tutorial videos</li>\r\n			<li>\r\n				Best Practice Knowledge Base</li>\r\n			<li>\r\n				User Forums</li>\r\n		</ul>\r\n	</li>\r\n</ul>\r\n', NULL, NULL, 100, 0, NULL, 7, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(960, 249, 0, 35, 'service', 'Data Conversion', NULL, NULL, NULL, NULL, 0, 2000, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, '', 1),
	(961, 250, 15, 1, 'product', 'ZH OpenEMR', '1', '<p>\r\n	Scheduling</p>\r\n<ul>\r\n	<li>\r\n		Supports multiple physicians and facilities</li>\r\n	<li>\r\n		Easy to manage appointment calendar</li>\r\n	<li>\r\n		Ability to assign olors to easily identify appointment types or facilities</li>\r\n	<li>\r\n		Supports repeating appointments and restricting appointments</li>\r\n	<li>\r\n		Supports patient reminders and notifications</li>\r\n	<li>\r\n		Physcian Reminders</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Patient Demographics</p>\r\n<ul>\r\n	<li>\r\n		Manage Patient Demographics</li>\r\n	<li>\r\n		Comprehensive patient identification profile information, including full name, date of birth, sex, identification, language, ethinicity, marital status</li>\r\n	<li>\r\n		Contact information for patient</li>\r\n	<li>\r\n		Emergency Contact information</li>\r\n	<li>\r\n		Employment Information</li>\r\n	<li>\r\n		Insurance Coverage</li>\r\n	<li>\r\n		Primary Provider</li>\r\n	<li>\r\n		HIPAA Information</li>\r\n	<li>\r\n		Fully Customizable to easily extend out of the box demographic profile</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Patient History</p>\r\n<ul>\r\n	<li>\r\n		Medical Issues</li>\r\n	<li>\r\n		Medications</li>\r\n	<li>\r\n		Immunizations</li>\r\n	<li>\r\n		Vitals</li>\r\n	<li>\r\n		Labs</li>\r\n	<li>\r\n		Procedures</li>\r\n	<li>\r\n		Clinical Decision Rules to check/monitor/alert clinical information (such as vitals, history information, medications, procedures, labs, etc.) in real time</li>\r\n	<li>\r\n		Clinical Measures Calculations</li>\r\n	<li>\r\n		Clinical Quality Measure Calculations</li>\r\n	<li>\r\n		Automated Measure Calculations (AMC) and Tracking</li>\r\n	<li>\r\n		Scan, link, and manage any document or picture</li>\r\n	<li>\r\n		Insurance Eligibility</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Encounters and Charting</p>\r\n<ul>\r\n	<li>\r\n		Fully customizable, template driven forms</li>\r\n	<li>\r\n		Comprehensive chart, visit summary, patient history views for quick updates</li>\r\n	<li>\r\n		Voice recognition ready</li>\r\n	<li>\r\n		Graphical Charting</li>\r\n	<li>\r\n		Easy to use Patient Notes with time savings features allowing saving of frequently used notes for reuse</li>\r\n	<li>\r\n		Diagnosis and procedure coding (CPT/ICD-9)</li>\r\n	<li>\r\n		Communications ready to create letters for insurance providers, referring physicians, or patients</li>\r\n	<li>\r\n		Electronic Syndrome Surveillance reporting</li>\r\n	<li>\r\n		Clinical Measures Calculations</li>\r\n	<li>\r\n		Clinical Quality Measure Calculations</li>\r\n	<li>\r\n		Automated Measure Calculations (AMC) and Tracking</li>\r\n	<li>\r\n		Hardcopy and eRX ready</li>\r\n	<li>\r\n		Paper Chart Tracking</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Billing and Receivables</p>\r\n<ul>\r\n	<li>\r\n		Flexible system of coding including CPT, HCPCS and ICD codes and the ability to add others</li>\r\n	<li>\r\n		Support for electronic billing to clearing houses such as Medavant/Capario and ZirMED using ANSI X12</li>\r\n	<li>\r\n		Support for paper claims</li>\r\n	<li>\r\n		Insurance Eligibility Queries</li>\r\n	<li>\r\n		Insurance Tracking Interface</li>\r\n	<li>\r\n		Accounts Receivable Interface</li>\r\n	<li>\r\n		Medical claim management interface</li>\r\n	<li>\r\n		EOB Entry Interface</li>\r\n	<li>\r\n		Customizable to work with a clearing house for automated 835 or ERA entry</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Additional Features</p>\r\n<ul>\r\n	<li>\r\n		Fully Customizable and Flexible to modify to how you work</li>\r\n	<li>\r\n		Supports use of multiple languages within the same clinic</li>\r\n	<li>\r\n		Robust reporting features with ability to create, enhance, and extend</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Certifications</p>\r\n<ul>\r\n	<li>\r\n		ONC Complete Ambulatory EHR Certified</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	<br />\r\n	Security</p>\r\n<ul>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ability to Encrypt Patient Documents</li>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Supports fine-grained per-user access controls</li>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Remotely accessible from any modern web browser with a suitable security certificate installed</li>\r\n</ul>\r\n', NULL, NULL, 75, 0, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(962, 250, 15, 36, 'product', 'ZH Patient Portal', '1', '<p>\r\n	ZH Patient Portal gives a direct online link between the provider and the patient to allow for easy resolution of questions, make it easier to complete required forms and overall provide a better service to your patients.</p>\r\n<ul>\r\n	<li>\r\n		Flexible and easily configurable to needs of each practice</li>\r\n	<li>\r\n		New patient can register online and complete pre-visit documents</li>\r\n	<li>\r\n		Patient can browse and make appointment online</li>\r\n	<li>\r\n		View and update patient profile inforamtion including demographic and insurance infomation</li>\r\n	<li>\r\n		Make payments online</li>\r\n	<li>\r\n		View medical records including lab results and presriptions</li>\r\n	<li>\r\n		View billing account and statements</li>\r\n	<li>\r\n		Communicate easily through a secure mailbox to request refills, referrals, or other information</li>\r\n</ul>\r\n', NULL, NULL, 0, 0, NULL, 2, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 1, '', 0),
	(963, 250, 15, 29, 'product', 'ZH Advanced Billing', '1', '<p>\r\n	The Advanced Billing module is focused on providing capabilities to manage and improve your revenue cycle by decreasing staff time needed to enter billing, process and manage insurance claims, record payments; improve the accuracy of coding of encounters; provide quick access to patient accounts for responding to inquiries and resolving status of claims.</p>\r\n<p>\r\n	<strong>Enhanced Billing and Claims Processing</strong></p>\r\n<p>\r\n	Smart Fee Sheet</p>\r\n<ul>\r\n	<li>\r\n		Easy to use template that looks like the paper superbill you are used to</li>\r\n	<li>\r\n		Store CPT, ICD valid codes for easy and correct entry</li>\r\n	<li>\r\n		Allows for multiple fee sheets for a single factility</li>\r\n	<li>\r\n		Allows advanced capaility to lock encounters that are not ready for billing</li>\r\n	<li>\r\n		Time saving ability to enter miscellaneous options without leaving the fee sheet</li>\r\n</ul>\r\n<p>\r\n	Batch Charge Entry to Support Larger Facilities</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter multiple claims from a single screen</li>\r\n	<li>\r\n		Allows for entry of new patients from the same screen</li>\r\n</ul>\r\n<p>\r\n	Real Time Eligibility Verification for Insurance</p>\r\n<p>\r\n	Billing Management</p>\r\n<ul>\r\n	<li>\r\n		Work on all claims from a single screen</li>\r\n	<li>\r\n		Advanced filters to see only the claims you are interested in working</li>\r\n	<li>\r\n		Allows to view fee sheet and demographics ledger</li>\r\n	<li>\r\n		Ability to fix all errors before submittal increasing First Pass Rate</li>\r\n	<li>\r\n		Data entry uses quality control verifying codes as you type and automatically applies relevant data (patient, provider, payer) from system database</li>\r\n	<li>\r\n		Generate HCFA, PDF, TXT, or Electronic Claims files</li>\r\n	<li>\r\n		Automatically generate and upload claims to clearing house</li>\r\n	<li>\r\n		Option to direct claims to 3rd party billing systems</li>\r\n	<li>\r\n		Supports multiple insurance company networks</li>\r\n	<li>\r\n		Ability to process secondary insurance claims</li>\r\n	<li>\r\n		Ability to write off balances</li>\r\n	<li>\r\n		Allows for moving balances to patient accounts</li>\r\n	<li>\r\n		Ability to send more than 4 diagnosis with claim</li>\r\n</ul>\r\n<p>\r\n	Clearing House Integration</p>\r\n<ul>\r\n	<li>\r\n		Seamless integration avoiding steps to generate and upload files separately</li>\r\n	<li>\r\n		Advanced import facility will import NPI and Tax ID numbers needed for posting payment from ERA</li>\r\n	<li>\r\n		Enhanced file summary of uploaded claimes to clearing house includes current status of the claims and response from the payer allowing ability to update the EMR database automatically</li>\r\n</ul>\r\n<p>\r\n	Rejected Claim Management</p>\r\n<ul>\r\n	<li>\r\n		Enhanced query ability to enable quick review to remedy errors and refile claims from a sign screen</li>\r\n	<li>\r\n		Stores history relating to why the claims were denied</li>\r\n</ul>\r\n<p>\r\n	<strong>Advanced Payment Receipt Processing</strong></p>\r\n<p>\r\n	Payments</p>\r\n<ul>\r\n	<li>\r\n		Easy entry of payments and adjustments</li>\r\n	<li>\r\n		Single screen to receive any payment method including cash, check, credit card</li>\r\n	<li>\r\n		Advanced search and filtering to view only the payments you wish to review</li>\r\n	<li>\r\n		Allows receipt from any type of payment source including advance payment, group payment, capitation payment, insurance payment</li>\r\n	<li>\r\n		Easily allocate payment or EOBs to specific encounters</li>\r\n	<li>\r\n		Easily allocate payment to specific CPTs within a claim and track unpaid CPTs within a claim</li>\r\n	<li>\r\n		Ability to enter payments to specific &quot;post to&quot; dates</li>\r\n	<li>\r\n		Easily enter data from EOBs and apply insurance company responses to patient accounts</li>\r\n	<li>\r\n		View and print original EOBs and other payment documents</li>\r\n</ul>\r\n<p>\r\n	ERA&nbsp; Posting</p>\r\n<ul>\r\n	<li>\r\n		Post individual ERA and automatically update to patient accounts</li>\r\n	<li>\r\n		Advanced ability to batch process ERA files from multiple insurance companies greatly reducing process time for larger facilities</li>\r\n</ul>\r\n<p>\r\n	Capitation Payments</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter and track capitation payments</li>\r\n	<li>\r\n		Analysis reporting for profitability of capitated patient encounters</li>\r\n</ul>\r\n<p>\r\n	<strong>Accounts Receivable Management</strong></p>\r\n<ul>\r\n	<li>\r\n		Full featured claims and action tracking allowing to monitor and report on claim status, alert for followups, and identify payer denied claims</li>\r\n	<li>\r\n		Supports claims appeal process to determine reason for denial, collection of needed additional information and resubmission of claim</li>\r\n	<li>\r\n		Maintains call log of followup actions</li>\r\n</ul>\r\n<p>\r\n	<strong>Patient Accounts</strong></p>\r\n<p>\r\n	Pre-Authorization Management</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter pre-autorization and plan details greatly reducing staff time needed to manage the variations of authorized treatment</li>\r\n	<li>\r\n		Track encounters based on number of visits, hours, specific CPTs</li>\r\n	<li>\r\n		Flag encounters where pre-autorization is not covered or reaches allowed coverage</li>\r\n</ul>\r\n<p>\r\n	Patient Ledger</p>\r\n<ul>\r\n	<li>\r\n		Elaborate patient ledger displaying total charges, amounts pending for each insurance, payments received, balance details detailing insurance versus patient portion</li>\r\n	<li>\r\n		Color coded line items to easily distingish services, patient payments, insurance payments, and adjustments</li>\r\n	<li>\r\n		One click viewing of underlying fee sheet or payment</li>\r\n	<li>\r\n		Quick printing directly from ledger of individual patient statement and patient ledger</li>\r\n</ul>\r\n<p>\r\n	Patient Statements</p>\r\n<ul>\r\n	<li>\r\n		Batch or individual printing of billing statements</li>\r\n	<li>\r\n		Quick access to billing statement and payment history from patient profile</li>\r\n	<li>\r\n		Easy billing lookup for responding to patient billing inquiries</li>\r\n</ul>\r\n<p>\r\n	<strong>Advanced Reporting</strong></p>\r\n<ul>\r\n	<li>\r\n		Library of reports to track accounts receivable, patients, and other financial information</li>\r\n	<li>\r\n		Ability to customize reports to needs</li>\r\n	<li>\r\n		Reporting memory option allowing specific filter and reporting queries to be saved for repeated use</li>\r\n	<li>\r\n		Export reports to PDF, Excel or CSV formats</li>\r\n</ul>\r\n', NULL, NULL, 75, 0, NULL, 3, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(964, 250, 15, 30, 'product', 'ZH eRx', '1', '<p>\r\n	ZHOpenEMR&rsquo;s electronic prescription or e-Prescription module enables your practice to facilitate faster delivery of medicines, refills, with accuracy. &nbsp;</p>\r\n<ul>\r\n	<li>\r\n		Submit electronic presriptions to any pharmacy</li>\r\n	<li>\r\n		Supports refill requests</li>\r\n	<li>\r\n		Includes drug-drug and drug-allergy interactions</li>\r\n	<li>\r\n		Allows ability to also print presriptions</li>\r\n	<li>\r\n		Available as a standalone product</li>\r\n</ul>\r\n', NULL, NULL, 35, 0, NULL, 4, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(965, 250, 15, 33, 'support', ' Preferred Support', '1', '<p>\r\n	Our most popular plan provides you with your reliable, always on, always up to date system as well as access to our customer care experts for addressing your technical and ZH OpenEMR software usage questions.</p>\r\n<p>\r\n	Plan Details:</p>\r\n<ul>\r\n	<li>\r\n		$100 per month per provider</li>\r\n	<li>\r\n		Unlimited Support Requests (Incidents)</li>\r\n	<li>\r\n		1 Named Contact&nbsp;&nbsp; &nbsp;&nbsp;</li>\r\n	<li>\r\n		Resolution for ZH -owned issues</li>\r\n	<li>\r\n		Support during Local business hours</li>\r\n	<li>\r\n		12 hour Initial Response Time</li>\r\n	<li>\r\n		Web Case Management</li>\r\n	<li>\r\n		Email Support</li>\r\n	<li>\r\n		One-on-one online support</li>\r\n	<li>\r\n		One-on-one phone support</li>\r\n	<li>\r\n		Remote Troubleshooting&nbsp; &nbsp;&nbsp;</li>\r\n	<li>\r\n		Best practice guidance</li>\r\n	<li>\r\n		Go-Live Assistance</li>\r\n	<li>\r\n		Scheduled Upgrade Assistance</li>\r\n	<li>\r\n		Self Help Support including:&nbsp; &nbsp; &nbsp;&nbsp;\r\n		<ul>\r\n			<li>\r\n				Account Portal</li>\r\n			<li>\r\n				Access to User Manuals</li>\r\n			<li>\r\n				Access to online tutorial videos</li>\r\n			<li>\r\n				Best Practice Knowledge Base</li>\r\n			<li>\r\n				User Forums</li>\r\n		</ul>\r\n	</li>\r\n</ul>\r\n', NULL, NULL, 100, 0, NULL, 7, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(966, 250, 0, 35, 'service', 'Data Conversion', NULL, NULL, NULL, NULL, 0, 2000, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, '', 1),
	(968, 250, 0, 31, 'product', 'ZH Lab Interface', NULL, NULL, NULL, NULL, 50, 0, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, '', 1),
	(969, 252, 15, 1, 'product', 'ZH OpenEMR', '1', '<p>\r\n	Scheduling</p>\r\n<ul>\r\n	<li>\r\n		Supports multiple physicians and facilities</li>\r\n	<li>\r\n		Easy to manage appointment calendar</li>\r\n	<li>\r\n		Ability to assign olors to easily identify appointment types or facilities</li>\r\n	<li>\r\n		Supports repeating appointments and restricting appointments</li>\r\n	<li>\r\n		Supports patient reminders and notifications</li>\r\n	<li>\r\n		Physcian Reminders</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Patient Demographics</p>\r\n<ul>\r\n	<li>\r\n		Manage Patient Demographics</li>\r\n	<li>\r\n		Comprehensive patient identification profile information, including full name, date of birth, sex, identification, language, ethinicity, marital status</li>\r\n	<li>\r\n		Contact information for patient</li>\r\n	<li>\r\n		Emergency Contact information</li>\r\n	<li>\r\n		Employment Information</li>\r\n	<li>\r\n		Insurance Coverage</li>\r\n	<li>\r\n		Primary Provider</li>\r\n	<li>\r\n		HIPAA Information</li>\r\n	<li>\r\n		Fully Customizable to easily extend out of the box demographic profile</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Patient History</p>\r\n<ul>\r\n	<li>\r\n		Medical Issues</li>\r\n	<li>\r\n		Medications</li>\r\n	<li>\r\n		Immunizations</li>\r\n	<li>\r\n		Vitals</li>\r\n	<li>\r\n		Labs</li>\r\n	<li>\r\n		Procedures</li>\r\n	<li>\r\n		Clinical Decision Rules to check/monitor/alert clinical information (such as vitals, history information, medications, procedures, labs, etc.) in real time</li>\r\n	<li>\r\n		Clinical Measures Calculations</li>\r\n	<li>\r\n		Clinical Quality Measure Calculations</li>\r\n	<li>\r\n		Automated Measure Calculations (AMC) and Tracking</li>\r\n	<li>\r\n		Scan, link, and manage any document or picture</li>\r\n	<li>\r\n		Insurance Eligibility</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Encounters and Charting</p>\r\n<ul>\r\n	<li>\r\n		Fully customizable, template driven forms</li>\r\n	<li>\r\n		Comprehensive chart, visit summary, patient history views for quick updates</li>\r\n	<li>\r\n		Voice recognition ready</li>\r\n	<li>\r\n		Graphical Charting</li>\r\n	<li>\r\n		Easy to use Patient Notes with time savings features allowing saving of frequently used notes for reuse</li>\r\n	<li>\r\n		Diagnosis and procedure coding (CPT/ICD-9)</li>\r\n	<li>\r\n		Communications ready to create letters for insurance providers, referring physicians, or patients</li>\r\n	<li>\r\n		Electronic Syndrome Surveillance reporting</li>\r\n	<li>\r\n		Clinical Measures Calculations</li>\r\n	<li>\r\n		Clinical Quality Measure Calculations</li>\r\n	<li>\r\n		Automated Measure Calculations (AMC) and Tracking</li>\r\n	<li>\r\n		Hardcopy and eRX ready</li>\r\n	<li>\r\n		Paper Chart Tracking</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Billing and Receivables</p>\r\n<ul>\r\n	<li>\r\n		Flexible system of coding including CPT, HCPCS and ICD codes and the ability to add others</li>\r\n	<li>\r\n		Support for electronic billing to clearing houses such as Medavant/Capario and ZirMED using ANSI X12</li>\r\n	<li>\r\n		Support for paper claims</li>\r\n	<li>\r\n		Insurance Eligibility Queries</li>\r\n	<li>\r\n		Insurance Tracking Interface</li>\r\n	<li>\r\n		Accounts Receivable Interface</li>\r\n	<li>\r\n		Medical claim management interface</li>\r\n	<li>\r\n		EOB Entry Interface</li>\r\n	<li>\r\n		Customizable to work with a clearing house for automated 835 or ERA entry</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Additional Features</p>\r\n<ul>\r\n	<li>\r\n		Fully Customizable and Flexible to modify to how you work</li>\r\n	<li>\r\n		Supports use of multiple languages within the same clinic</li>\r\n	<li>\r\n		Robust reporting features with ability to create, enhance, and extend</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Certifications</p>\r\n<ul>\r\n	<li>\r\n		ONC Complete Ambulatory EHR Certified</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	<br />\r\n	Security</p>\r\n<ul>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ability to Encrypt Patient Documents</li>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Supports fine-grained per-user access controls</li>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Remotely accessible from any modern web browser with a suitable security certificate installed</li>\r\n</ul>\r\n', NULL, NULL, 75, 0, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(970, 252, 15, 36, 'product', 'ZH Patient Portal', '1', '<p>\r\n	ZH Patient Portal gives a direct online link between the provider and the patient to allow for easy resolution of questions, make it easier to complete required forms and overall provide a better service to your patients.</p>\r\n<ul>\r\n	<li>\r\n		Flexible and easily configurable to needs of each practice</li>\r\n	<li>\r\n		New patient can register online and complete pre-visit documents</li>\r\n	<li>\r\n		Patient can browse and make appointment online</li>\r\n	<li>\r\n		View and update patient profile inforamtion including demographic and insurance infomation</li>\r\n	<li>\r\n		Make payments online</li>\r\n	<li>\r\n		View medical records including lab results and presriptions</li>\r\n	<li>\r\n		View billing account and statements</li>\r\n	<li>\r\n		Communicate easily through a secure mailbox to request refills, referrals, or other information</li>\r\n</ul>\r\n', NULL, NULL, 0, 0, NULL, 2, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 1, '', 0),
	(971, 252, 15, 29, 'product', 'ZH Advanced Billing', '1', '<p>\r\n	The Advanced Billing module is focused on providing capabilities to manage and improve your revenue cycle by decreasing staff time needed to enter billing, process and manage insurance claims, record payments; improve the accuracy of coding of encounters; provide quick access to patient accounts for responding to inquiries and resolving status of claims.</p>\r\n<p>\r\n	<strong>Enhanced Billing and Claims Processing</strong></p>\r\n<p>\r\n	Smart Fee Sheet</p>\r\n<ul>\r\n	<li>\r\n		Easy to use template that looks like the paper superbill you are used to</li>\r\n	<li>\r\n		Store CPT, ICD valid codes for easy and correct entry</li>\r\n	<li>\r\n		Allows for multiple fee sheets for a single factility</li>\r\n	<li>\r\n		Allows advanced capaility to lock encounters that are not ready for billing</li>\r\n	<li>\r\n		Time saving ability to enter miscellaneous options without leaving the fee sheet</li>\r\n</ul>\r\n<p>\r\n	Batch Charge Entry to Support Larger Facilities</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter multiple claims from a single screen</li>\r\n	<li>\r\n		Allows for entry of new patients from the same screen</li>\r\n</ul>\r\n<p>\r\n	Real Time Eligibility Verification for Insurance</p>\r\n<p>\r\n	Billing Management</p>\r\n<ul>\r\n	<li>\r\n		Work on all claims from a single screen</li>\r\n	<li>\r\n		Advanced filters to see only the claims you are interested in working</li>\r\n	<li>\r\n		Allows to view fee sheet and demographics ledger</li>\r\n	<li>\r\n		Ability to fix all errors before submittal increasing First Pass Rate</li>\r\n	<li>\r\n		Data entry uses quality control verifying codes as you type and automatically applies relevant data (patient, provider, payer) from system database</li>\r\n	<li>\r\n		Generate HCFA, PDF, TXT, or Electronic Claims files</li>\r\n	<li>\r\n		Automatically generate and upload claims to clearing house</li>\r\n	<li>\r\n		Option to direct claims to 3rd party billing systems</li>\r\n	<li>\r\n		Supports multiple insurance company networks</li>\r\n	<li>\r\n		Ability to process secondary insurance claims</li>\r\n	<li>\r\n		Ability to write off balances</li>\r\n	<li>\r\n		Allows for moving balances to patient accounts</li>\r\n	<li>\r\n		Ability to send more than 4 diagnosis with claim</li>\r\n</ul>\r\n<p>\r\n	Clearing House Integration</p>\r\n<ul>\r\n	<li>\r\n		Seamless integration avoiding steps to generate and upload files separately</li>\r\n	<li>\r\n		Advanced import facility will import NPI and Tax ID numbers needed for posting payment from ERA</li>\r\n	<li>\r\n		Enhanced file summary of uploaded claimes to clearing house includes current status of the claims and response from the payer allowing ability to update the EMR database automatically</li>\r\n</ul>\r\n<p>\r\n	Rejected Claim Management</p>\r\n<ul>\r\n	<li>\r\n		Enhanced query ability to enable quick review to remedy errors and refile claims from a sign screen</li>\r\n	<li>\r\n		Stores history relating to why the claims were denied</li>\r\n</ul>\r\n<p>\r\n	<strong>Advanced Payment Receipt Processing</strong></p>\r\n<p>\r\n	Payments</p>\r\n<ul>\r\n	<li>\r\n		Easy entry of payments and adjustments</li>\r\n	<li>\r\n		Single screen to receive any payment method including cash, check, credit card</li>\r\n	<li>\r\n		Advanced search and filtering to view only the payments you wish to review</li>\r\n	<li>\r\n		Allows receipt from any type of payment source including advance payment, group payment, capitation payment, insurance payment</li>\r\n	<li>\r\n		Easily allocate payment or EOBs to specific encounters</li>\r\n	<li>\r\n		Easily allocate payment to specific CPTs within a claim and track unpaid CPTs within a claim</li>\r\n	<li>\r\n		Ability to enter payments to specific &quot;post to&quot; dates</li>\r\n	<li>\r\n		Easily enter data from EOBs and apply insurance company responses to patient accounts</li>\r\n	<li>\r\n		View and print original EOBs and other payment documents</li>\r\n</ul>\r\n<p>\r\n	ERA&nbsp; Posting</p>\r\n<ul>\r\n	<li>\r\n		Post individual ERA and automatically update to patient accounts</li>\r\n	<li>\r\n		Advanced ability to batch process ERA files from multiple insurance companies greatly reducing process time for larger facilities</li>\r\n</ul>\r\n<p>\r\n	Capitation Payments</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter and track capitation payments</li>\r\n	<li>\r\n		Analysis reporting for profitability of capitated patient encounters</li>\r\n</ul>\r\n<p>\r\n	<strong>Accounts Receivable Management</strong></p>\r\n<ul>\r\n	<li>\r\n		Full featured claims and action tracking allowing to monitor and report on claim status, alert for followups, and identify payer denied claims</li>\r\n	<li>\r\n		Supports claims appeal process to determine reason for denial, collection of needed additional information and resubmission of claim</li>\r\n	<li>\r\n		Maintains call log of followup actions</li>\r\n</ul>\r\n<p>\r\n	<strong>Patient Accounts</strong></p>\r\n<p>\r\n	Pre-Authorization Management</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter pre-autorization and plan details greatly reducing staff time needed to manage the variations of authorized treatment</li>\r\n	<li>\r\n		Track encounters based on number of visits, hours, specific CPTs</li>\r\n	<li>\r\n		Flag encounters where pre-autorization is not covered or reaches allowed coverage</li>\r\n</ul>\r\n<p>\r\n	Patient Ledger</p>\r\n<ul>\r\n	<li>\r\n		Elaborate patient ledger displaying total charges, amounts pending for each insurance, payments received, balance details detailing insurance versus patient portion</li>\r\n	<li>\r\n		Color coded line items to easily distingish services, patient payments, insurance payments, and adjustments</li>\r\n	<li>\r\n		One click viewing of underlying fee sheet or payment</li>\r\n	<li>\r\n		Quick printing directly from ledger of individual patient statement and patient ledger</li>\r\n</ul>\r\n<p>\r\n	Patient Statements</p>\r\n<ul>\r\n	<li>\r\n		Batch or individual printing of billing statements</li>\r\n	<li>\r\n		Quick access to billing statement and payment history from patient profile</li>\r\n	<li>\r\n		Easy billing lookup for responding to patient billing inquiries</li>\r\n</ul>\r\n<p>\r\n	<strong>Advanced Reporting</strong></p>\r\n<ul>\r\n	<li>\r\n		Library of reports to track accounts receivable, patients, and other financial information</li>\r\n	<li>\r\n		Ability to customize reports to needs</li>\r\n	<li>\r\n		Reporting memory option allowing specific filter and reporting queries to be saved for repeated use</li>\r\n	<li>\r\n		Export reports to PDF, Excel or CSV formats</li>\r\n</ul>\r\n', NULL, NULL, 75, 0, NULL, 3, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(972, 252, 15, 30, 'product', 'ZH eRx', '1', '<p>\r\n	ZHOpenEMR&rsquo;s electronic prescription or e-Prescription module enables your practice to facilitate faster delivery of medicines, refills, with accuracy. &nbsp;</p>\r\n<ul>\r\n	<li>\r\n		Submit electronic presriptions to any pharmacy</li>\r\n	<li>\r\n		Supports refill requests</li>\r\n	<li>\r\n		Includes drug-drug and drug-allergy interactions</li>\r\n	<li>\r\n		Allows ability to also print presriptions</li>\r\n	<li>\r\n		Available as a standalone product</li>\r\n</ul>\r\n', NULL, NULL, 35, 0, NULL, 4, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(973, 252, 15, 33, 'support', ' Preferred Support', '1', '<p>\r\n	Our most popular plan provides you with your reliable, always on, always up to date system as well as access to our customer care experts for addressing your technical and ZH OpenEMR software usage questions.</p>\r\n<p>\r\n	Plan Details:</p>\r\n<ul>\r\n	<li>\r\n		$100 per month per provider</li>\r\n	<li>\r\n		Unlimited Support Requests (Incidents)</li>\r\n	<li>\r\n		1 Named Contact&nbsp;&nbsp; &nbsp;&nbsp;</li>\r\n	<li>\r\n		Resolution for ZH -owned issues</li>\r\n	<li>\r\n		Support during Local business hours</li>\r\n	<li>\r\n		12 hour Initial Response Time</li>\r\n	<li>\r\n		Web Case Management</li>\r\n	<li>\r\n		Email Support</li>\r\n	<li>\r\n		One-on-one online support</li>\r\n	<li>\r\n		One-on-one phone support</li>\r\n	<li>\r\n		Remote Troubleshooting&nbsp; &nbsp;&nbsp;</li>\r\n	<li>\r\n		Best practice guidance</li>\r\n	<li>\r\n		Go-Live Assistance</li>\r\n	<li>\r\n		Scheduled Upgrade Assistance</li>\r\n	<li>\r\n		Self Help Support including:&nbsp; &nbsp; &nbsp;&nbsp;\r\n		<ul>\r\n			<li>\r\n				Account Portal</li>\r\n			<li>\r\n				Access to User Manuals</li>\r\n			<li>\r\n				Access to online tutorial videos</li>\r\n			<li>\r\n				Best Practice Knowledge Base</li>\r\n			<li>\r\n				User Forums</li>\r\n		</ul>\r\n	</li>\r\n</ul>\r\n', NULL, NULL, 100, 0, NULL, 7, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(974, 253, 15, 1, 'product', 'ZH OpenEMR', '1', '<p>\r\n	Scheduling</p>\r\n<ul>\r\n	<li>\r\n		Supports multiple physicians and facilities</li>\r\n	<li>\r\n		Easy to manage appointment calendar</li>\r\n	<li>\r\n		Ability to assign olors to easily identify appointment types or facilities</li>\r\n	<li>\r\n		Supports repeating appointments and restricting appointments</li>\r\n	<li>\r\n		Supports patient reminders and notifications</li>\r\n	<li>\r\n		Physcian Reminders</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Patient Demographics</p>\r\n<ul>\r\n	<li>\r\n		Manage Patient Demographics</li>\r\n	<li>\r\n		Comprehensive patient identification profile information, including full name, date of birth, sex, identification, language, ethinicity, marital status</li>\r\n	<li>\r\n		Contact information for patient</li>\r\n	<li>\r\n		Emergency Contact information</li>\r\n	<li>\r\n		Employment Information</li>\r\n	<li>\r\n		Insurance Coverage</li>\r\n	<li>\r\n		Primary Provider</li>\r\n	<li>\r\n		HIPAA Information</li>\r\n	<li>\r\n		Fully Customizable to easily extend out of the box demographic profile</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Patient History</p>\r\n<ul>\r\n	<li>\r\n		Medical Issues</li>\r\n	<li>\r\n		Medications</li>\r\n	<li>\r\n		Immunizations</li>\r\n	<li>\r\n		Vitals</li>\r\n	<li>\r\n		Labs</li>\r\n	<li>\r\n		Procedures</li>\r\n	<li>\r\n		Clinical Decision Rules to check/monitor/alert clinical information (such as vitals, history information, medications, procedures, labs, etc.) in real time</li>\r\n	<li>\r\n		Clinical Measures Calculations</li>\r\n	<li>\r\n		Clinical Quality Measure Calculations</li>\r\n	<li>\r\n		Automated Measure Calculations (AMC) and Tracking</li>\r\n	<li>\r\n		Scan, link, and manage any document or picture</li>\r\n	<li>\r\n		Insurance Eligibility</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Encounters and Charting</p>\r\n<ul>\r\n	<li>\r\n		Fully customizable, template driven forms</li>\r\n	<li>\r\n		Comprehensive chart, visit summary, patient history views for quick updates</li>\r\n	<li>\r\n		Voice recognition ready</li>\r\n	<li>\r\n		Graphical Charting</li>\r\n	<li>\r\n		Easy to use Patient Notes with time savings features allowing saving of frequently used notes for reuse</li>\r\n	<li>\r\n		Diagnosis and procedure coding (CPT/ICD-9)</li>\r\n	<li>\r\n		Communications ready to create letters for insurance providers, referring physicians, or patients</li>\r\n	<li>\r\n		Electronic Syndrome Surveillance reporting</li>\r\n	<li>\r\n		Clinical Measures Calculations</li>\r\n	<li>\r\n		Clinical Quality Measure Calculations</li>\r\n	<li>\r\n		Automated Measure Calculations (AMC) and Tracking</li>\r\n	<li>\r\n		Hardcopy and eRX ready</li>\r\n	<li>\r\n		Paper Chart Tracking</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Billing and Receivables</p>\r\n<ul>\r\n	<li>\r\n		Flexible system of coding including CPT, HCPCS and ICD codes and the ability to add others</li>\r\n	<li>\r\n		Support for electronic billing to clearing houses such as Medavant/Capario and ZirMED using ANSI X12</li>\r\n	<li>\r\n		Support for paper claims</li>\r\n	<li>\r\n		Insurance Eligibility Queries</li>\r\n	<li>\r\n		Insurance Tracking Interface</li>\r\n	<li>\r\n		Accounts Receivable Interface</li>\r\n	<li>\r\n		Medical claim management interface</li>\r\n	<li>\r\n		EOB Entry Interface</li>\r\n	<li>\r\n		Customizable to work with a clearing house for automated 835 or ERA entry</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Additional Features</p>\r\n<ul>\r\n	<li>\r\n		Fully Customizable and Flexible to modify to how you work</li>\r\n	<li>\r\n		Supports use of multiple languages within the same clinic</li>\r\n	<li>\r\n		Robust reporting features with ability to create, enhance, and extend</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Certifications</p>\r\n<ul>\r\n	<li>\r\n		ONC Complete Ambulatory EHR Certified</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	<br />\r\n	Security</p>\r\n<ul>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ability to Encrypt Patient Documents</li>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Supports fine-grained per-user access controls</li>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Remotely accessible from any modern web browser with a suitable security certificate installed</li>\r\n</ul>\r\n', NULL, NULL, 75, 0, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(975, 253, 15, 36, 'product', 'ZH Patient Portal', '1', '<p>\r\n	ZH Patient Portal gives a direct online link between the provider and the patient to allow for easy resolution of questions, make it easier to complete required forms and overall provide a better service to your patients.</p>\r\n<ul>\r\n	<li>\r\n		Flexible and easily configurable to needs of each practice</li>\r\n	<li>\r\n		New patient can register online and complete pre-visit documents</li>\r\n	<li>\r\n		Patient can browse and make appointment online</li>\r\n	<li>\r\n		View and update patient profile inforamtion including demographic and insurance infomation</li>\r\n	<li>\r\n		Make payments online</li>\r\n	<li>\r\n		View medical records including lab results and presriptions</li>\r\n	<li>\r\n		View billing account and statements</li>\r\n	<li>\r\n		Communicate easily through a secure mailbox to request refills, referrals, or other information</li>\r\n</ul>\r\n', NULL, NULL, 0, 0, NULL, 2, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 1, '', 0),
	(976, 253, 15, 29, 'product', 'ZH Advanced Billing', '1', '<p>\r\n	The Advanced Billing module is focused on providing capabilities to manage and improve your revenue cycle by decreasing staff time needed to enter billing, process and manage insurance claims, record payments; improve the accuracy of coding of encounters; provide quick access to patient accounts for responding to inquiries and resolving status of claims.</p>\r\n<p>\r\n	<strong>Enhanced Billing and Claims Processing</strong></p>\r\n<p>\r\n	Smart Fee Sheet</p>\r\n<ul>\r\n	<li>\r\n		Easy to use template that looks like the paper superbill you are used to</li>\r\n	<li>\r\n		Store CPT, ICD valid codes for easy and correct entry</li>\r\n	<li>\r\n		Allows for multiple fee sheets for a single factility</li>\r\n	<li>\r\n		Allows advanced capaility to lock encounters that are not ready for billing</li>\r\n	<li>\r\n		Time saving ability to enter miscellaneous options without leaving the fee sheet</li>\r\n</ul>\r\n<p>\r\n	Batch Charge Entry to Support Larger Facilities</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter multiple claims from a single screen</li>\r\n	<li>\r\n		Allows for entry of new patients from the same screen</li>\r\n</ul>\r\n<p>\r\n	Real Time Eligibility Verification for Insurance</p>\r\n<p>\r\n	Billing Management</p>\r\n<ul>\r\n	<li>\r\n		Work on all claims from a single screen</li>\r\n	<li>\r\n		Advanced filters to see only the claims you are interested in working</li>\r\n	<li>\r\n		Allows to view fee sheet and demographics ledger</li>\r\n	<li>\r\n		Ability to fix all errors before submittal increasing First Pass Rate</li>\r\n	<li>\r\n		Data entry uses quality control verifying codes as you type and automatically applies relevant data (patient, provider, payer) from system database</li>\r\n	<li>\r\n		Generate HCFA, PDF, TXT, or Electronic Claims files</li>\r\n	<li>\r\n		Automatically generate and upload claims to clearing house</li>\r\n	<li>\r\n		Option to direct claims to 3rd party billing systems</li>\r\n	<li>\r\n		Supports multiple insurance company networks</li>\r\n	<li>\r\n		Ability to process secondary insurance claims</li>\r\n	<li>\r\n		Ability to write off balances</li>\r\n	<li>\r\n		Allows for moving balances to patient accounts</li>\r\n	<li>\r\n		Ability to send more than 4 diagnosis with claim</li>\r\n</ul>\r\n<p>\r\n	Clearing House Integration</p>\r\n<ul>\r\n	<li>\r\n		Seamless integration avoiding steps to generate and upload files separately</li>\r\n	<li>\r\n		Advanced import facility will import NPI and Tax ID numbers needed for posting payment from ERA</li>\r\n	<li>\r\n		Enhanced file summary of uploaded claimes to clearing house includes current status of the claims and response from the payer allowing ability to update the EMR database automatically</li>\r\n</ul>\r\n<p>\r\n	Rejected Claim Management</p>\r\n<ul>\r\n	<li>\r\n		Enhanced query ability to enable quick review to remedy errors and refile claims from a sign screen</li>\r\n	<li>\r\n		Stores history relating to why the claims were denied</li>\r\n</ul>\r\n<p>\r\n	<strong>Advanced Payment Receipt Processing</strong></p>\r\n<p>\r\n	Payments</p>\r\n<ul>\r\n	<li>\r\n		Easy entry of payments and adjustments</li>\r\n	<li>\r\n		Single screen to receive any payment method including cash, check, credit card</li>\r\n	<li>\r\n		Advanced search and filtering to view only the payments you wish to review</li>\r\n	<li>\r\n		Allows receipt from any type of payment source including advance payment, group payment, capitation payment, insurance payment</li>\r\n	<li>\r\n		Easily allocate payment or EOBs to specific encounters</li>\r\n	<li>\r\n		Easily allocate payment to specific CPTs within a claim and track unpaid CPTs within a claim</li>\r\n	<li>\r\n		Ability to enter payments to specific &quot;post to&quot; dates</li>\r\n	<li>\r\n		Easily enter data from EOBs and apply insurance company responses to patient accounts</li>\r\n	<li>\r\n		View and print original EOBs and other payment documents</li>\r\n</ul>\r\n<p>\r\n	ERA&nbsp; Posting</p>\r\n<ul>\r\n	<li>\r\n		Post individual ERA and automatically update to patient accounts</li>\r\n	<li>\r\n		Advanced ability to batch process ERA files from multiple insurance companies greatly reducing process time for larger facilities</li>\r\n</ul>\r\n<p>\r\n	Capitation Payments</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter and track capitation payments</li>\r\n	<li>\r\n		Analysis reporting for profitability of capitated patient encounters</li>\r\n</ul>\r\n<p>\r\n	<strong>Accounts Receivable Management</strong></p>\r\n<ul>\r\n	<li>\r\n		Full featured claims and action tracking allowing to monitor and report on claim status, alert for followups, and identify payer denied claims</li>\r\n	<li>\r\n		Supports claims appeal process to determine reason for denial, collection of needed additional information and resubmission of claim</li>\r\n	<li>\r\n		Maintains call log of followup actions</li>\r\n</ul>\r\n<p>\r\n	<strong>Patient Accounts</strong></p>\r\n<p>\r\n	Pre-Authorization Management</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter pre-autorization and plan details greatly reducing staff time needed to manage the variations of authorized treatment</li>\r\n	<li>\r\n		Track encounters based on number of visits, hours, specific CPTs</li>\r\n	<li>\r\n		Flag encounters where pre-autorization is not covered or reaches allowed coverage</li>\r\n</ul>\r\n<p>\r\n	Patient Ledger</p>\r\n<ul>\r\n	<li>\r\n		Elaborate patient ledger displaying total charges, amounts pending for each insurance, payments received, balance details detailing insurance versus patient portion</li>\r\n	<li>\r\n		Color coded line items to easily distingish services, patient payments, insurance payments, and adjustments</li>\r\n	<li>\r\n		One click viewing of underlying fee sheet or payment</li>\r\n	<li>\r\n		Quick printing directly from ledger of individual patient statement and patient ledger</li>\r\n</ul>\r\n<p>\r\n	Patient Statements</p>\r\n<ul>\r\n	<li>\r\n		Batch or individual printing of billing statements</li>\r\n	<li>\r\n		Quick access to billing statement and payment history from patient profile</li>\r\n	<li>\r\n		Easy billing lookup for responding to patient billing inquiries</li>\r\n</ul>\r\n<p>\r\n	<strong>Advanced Reporting</strong></p>\r\n<ul>\r\n	<li>\r\n		Library of reports to track accounts receivable, patients, and other financial information</li>\r\n	<li>\r\n		Ability to customize reports to needs</li>\r\n	<li>\r\n		Reporting memory option allowing specific filter and reporting queries to be saved for repeated use</li>\r\n	<li>\r\n		Export reports to PDF, Excel or CSV formats</li>\r\n</ul>\r\n', NULL, NULL, 75, 0, NULL, 3, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(977, 253, 15, 30, 'product', 'ZH eRx', '1', '<p>\r\n	ZHOpenEMR&rsquo;s electronic prescription or e-Prescription module enables your practice to facilitate faster delivery of medicines, refills, with accuracy. &nbsp;</p>\r\n<ul>\r\n	<li>\r\n		Submit electronic presriptions to any pharmacy</li>\r\n	<li>\r\n		Supports refill requests</li>\r\n	<li>\r\n		Includes drug-drug and drug-allergy interactions</li>\r\n	<li>\r\n		Allows ability to also print presriptions</li>\r\n	<li>\r\n		Available as a standalone product</li>\r\n</ul>\r\n', NULL, NULL, 35, 0, NULL, 4, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(978, 253, 15, 33, 'support', ' Preferred Support', '1', '<p>\r\n	Our most popular plan provides you with your reliable, always on, always up to date system as well as access to our customer care experts for addressing your technical and ZH OpenEMR software usage questions.</p>\r\n<p>\r\n	Plan Details:</p>\r\n<ul>\r\n	<li>\r\n		$100 per month per provider</li>\r\n	<li>\r\n		Unlimited Support Requests (Incidents)</li>\r\n	<li>\r\n		1 Named Contact&nbsp;&nbsp; &nbsp;&nbsp;</li>\r\n	<li>\r\n		Resolution for ZH -owned issues</li>\r\n	<li>\r\n		Support during Local business hours</li>\r\n	<li>\r\n		12 hour Initial Response Time</li>\r\n	<li>\r\n		Web Case Management</li>\r\n	<li>\r\n		Email Support</li>\r\n	<li>\r\n		One-on-one online support</li>\r\n	<li>\r\n		One-on-one phone support</li>\r\n	<li>\r\n		Remote Troubleshooting&nbsp; &nbsp;&nbsp;</li>\r\n	<li>\r\n		Best practice guidance</li>\r\n	<li>\r\n		Go-Live Assistance</li>\r\n	<li>\r\n		Scheduled Upgrade Assistance</li>\r\n	<li>\r\n		Self Help Support including:&nbsp; &nbsp; &nbsp;&nbsp;\r\n		<ul>\r\n			<li>\r\n				Account Portal</li>\r\n			<li>\r\n				Access to User Manuals</li>\r\n			<li>\r\n				Access to online tutorial videos</li>\r\n			<li>\r\n				Best Practice Knowledge Base</li>\r\n			<li>\r\n				User Forums</li>\r\n		</ul>\r\n	</li>\r\n</ul>\r\n', NULL, NULL, 100, 0, NULL, 7, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(979, 254, 15, 1, 'product', 'ZH OpenEMR', '1', '<p>\r\n	Scheduling</p>\r\n<ul>\r\n	<li>\r\n		Supports multiple physicians and facilities</li>\r\n	<li>\r\n		Easy to manage appointment calendar</li>\r\n	<li>\r\n		Ability to assign olors to easily identify appointment types or facilities</li>\r\n	<li>\r\n		Supports repeating appointments and restricting appointments</li>\r\n	<li>\r\n		Supports patient reminders and notifications</li>\r\n	<li>\r\n		Physcian Reminders</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Patient Demographics</p>\r\n<ul>\r\n	<li>\r\n		Manage Patient Demographics</li>\r\n	<li>\r\n		Comprehensive patient identification profile information, including full name, date of birth, sex, identification, language, ethinicity, marital status</li>\r\n	<li>\r\n		Contact information for patient</li>\r\n	<li>\r\n		Emergency Contact information</li>\r\n	<li>\r\n		Employment Information</li>\r\n	<li>\r\n		Insurance Coverage</li>\r\n	<li>\r\n		Primary Provider</li>\r\n	<li>\r\n		HIPAA Information</li>\r\n	<li>\r\n		Fully Customizable to easily extend out of the box demographic profile</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Patient History</p>\r\n<ul>\r\n	<li>\r\n		Medical Issues</li>\r\n	<li>\r\n		Medications</li>\r\n	<li>\r\n		Immunizations</li>\r\n	<li>\r\n		Vitals</li>\r\n	<li>\r\n		Labs</li>\r\n	<li>\r\n		Procedures</li>\r\n	<li>\r\n		Clinical Decision Rules to check/monitor/alert clinical information (such as vitals, history information, medications, procedures, labs, etc.) in real time</li>\r\n	<li>\r\n		Clinical Measures Calculations</li>\r\n	<li>\r\n		Clinical Quality Measure Calculations</li>\r\n	<li>\r\n		Automated Measure Calculations (AMC) and Tracking</li>\r\n	<li>\r\n		Scan, link, and manage any document or picture</li>\r\n	<li>\r\n		Insurance Eligibility</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Encounters and Charting</p>\r\n<ul>\r\n	<li>\r\n		Fully customizable, template driven forms</li>\r\n	<li>\r\n		Comprehensive chart, visit summary, patient history views for quick updates</li>\r\n	<li>\r\n		Voice recognition ready</li>\r\n	<li>\r\n		Graphical Charting</li>\r\n	<li>\r\n		Easy to use Patient Notes with time savings features allowing saving of frequently used notes for reuse</li>\r\n	<li>\r\n		Diagnosis and procedure coding (CPT/ICD-9)</li>\r\n	<li>\r\n		Communications ready to create letters for insurance providers, referring physicians, or patients</li>\r\n	<li>\r\n		Electronic Syndrome Surveillance reporting</li>\r\n	<li>\r\n		Clinical Measures Calculations</li>\r\n	<li>\r\n		Clinical Quality Measure Calculations</li>\r\n	<li>\r\n		Automated Measure Calculations (AMC) and Tracking</li>\r\n	<li>\r\n		Hardcopy and eRX ready</li>\r\n	<li>\r\n		Paper Chart Tracking</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Billing and Receivables</p>\r\n<ul>\r\n	<li>\r\n		Flexible system of coding including CPT, HCPCS and ICD codes and the ability to add others</li>\r\n	<li>\r\n		Support for electronic billing to clearing houses such as Medavant/Capario and ZirMED using ANSI X12</li>\r\n	<li>\r\n		Support for paper claims</li>\r\n	<li>\r\n		Insurance Eligibility Queries</li>\r\n	<li>\r\n		Insurance Tracking Interface</li>\r\n	<li>\r\n		Accounts Receivable Interface</li>\r\n	<li>\r\n		Medical claim management interface</li>\r\n	<li>\r\n		EOB Entry Interface</li>\r\n	<li>\r\n		Customizable to work with a clearing house for automated 835 or ERA entry</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Additional Features</p>\r\n<ul>\r\n	<li>\r\n		Fully Customizable and Flexible to modify to how you work</li>\r\n	<li>\r\n		Supports use of multiple languages within the same clinic</li>\r\n	<li>\r\n		Robust reporting features with ability to create, enhance, and extend</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Certifications</p>\r\n<ul>\r\n	<li>\r\n		ONC Complete Ambulatory EHR Certified</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	<br />\r\n	Security</p>\r\n<ul>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ability to Encrypt Patient Documents</li>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Supports fine-grained per-user access controls</li>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Remotely accessible from any modern web browser with a suitable security certificate installed</li>\r\n</ul>\r\n', NULL, NULL, 75, 0, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(980, 254, 15, 36, 'product', 'ZH Patient Portal', '1', '<p>\r\n	ZH Patient Portal gives a direct online link between the provider and the patient to allow for easy resolution of questions, make it easier to complete required forms and overall provide a better service to your patients.</p>\r\n<ul>\r\n	<li>\r\n		Flexible and easily configurable to needs of each practice</li>\r\n	<li>\r\n		New patient can register online and complete pre-visit documents</li>\r\n	<li>\r\n		Patient can browse and make appointment online</li>\r\n	<li>\r\n		View and update patient profile inforamtion including demographic and insurance infomation</li>\r\n	<li>\r\n		Make payments online</li>\r\n	<li>\r\n		View medical records including lab results and presriptions</li>\r\n	<li>\r\n		View billing account and statements</li>\r\n	<li>\r\n		Communicate easily through a secure mailbox to request refills, referrals, or other information</li>\r\n</ul>\r\n', NULL, NULL, 0, 0, NULL, 2, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 1, '', 0),
	(981, 254, 15, 29, 'product', 'ZH Advanced Billing', '1', '<p>\r\n	The Advanced Billing module is focused on providing capabilities to manage and improve your revenue cycle by decreasing staff time needed to enter billing, process and manage insurance claims, record payments; improve the accuracy of coding of encounters; provide quick access to patient accounts for responding to inquiries and resolving status of claims.</p>\r\n<p>\r\n	<strong>Enhanced Billing and Claims Processing</strong></p>\r\n<p>\r\n	Smart Fee Sheet</p>\r\n<ul>\r\n	<li>\r\n		Easy to use template that looks like the paper superbill you are used to</li>\r\n	<li>\r\n		Store CPT, ICD valid codes for easy and correct entry</li>\r\n	<li>\r\n		Allows for multiple fee sheets for a single factility</li>\r\n	<li>\r\n		Allows advanced capaility to lock encounters that are not ready for billing</li>\r\n	<li>\r\n		Time saving ability to enter miscellaneous options without leaving the fee sheet</li>\r\n</ul>\r\n<p>\r\n	Batch Charge Entry to Support Larger Facilities</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter multiple claims from a single screen</li>\r\n	<li>\r\n		Allows for entry of new patients from the same screen</li>\r\n</ul>\r\n<p>\r\n	Real Time Eligibility Verification for Insurance</p>\r\n<p>\r\n	Billing Management</p>\r\n<ul>\r\n	<li>\r\n		Work on all claims from a single screen</li>\r\n	<li>\r\n		Advanced filters to see only the claims you are interested in working</li>\r\n	<li>\r\n		Allows to view fee sheet and demographics ledger</li>\r\n	<li>\r\n		Ability to fix all errors before submittal increasing First Pass Rate</li>\r\n	<li>\r\n		Data entry uses quality control verifying codes as you type and automatically applies relevant data (patient, provider, payer) from system database</li>\r\n	<li>\r\n		Generate HCFA, PDF, TXT, or Electronic Claims files</li>\r\n	<li>\r\n		Automatically generate and upload claims to clearing house</li>\r\n	<li>\r\n		Option to direct claims to 3rd party billing systems</li>\r\n	<li>\r\n		Supports multiple insurance company networks</li>\r\n	<li>\r\n		Ability to process secondary insurance claims</li>\r\n	<li>\r\n		Ability to write off balances</li>\r\n	<li>\r\n		Allows for moving balances to patient accounts</li>\r\n	<li>\r\n		Ability to send more than 4 diagnosis with claim</li>\r\n</ul>\r\n<p>\r\n	Clearing House Integration</p>\r\n<ul>\r\n	<li>\r\n		Seamless integration avoiding steps to generate and upload files separately</li>\r\n	<li>\r\n		Advanced import facility will import NPI and Tax ID numbers needed for posting payment from ERA</li>\r\n	<li>\r\n		Enhanced file summary of uploaded claimes to clearing house includes current status of the claims and response from the payer allowing ability to update the EMR database automatically</li>\r\n</ul>\r\n<p>\r\n	Rejected Claim Management</p>\r\n<ul>\r\n	<li>\r\n		Enhanced query ability to enable quick review to remedy errors and refile claims from a sign screen</li>\r\n	<li>\r\n		Stores history relating to why the claims were denied</li>\r\n</ul>\r\n<p>\r\n	<strong>Advanced Payment Receipt Processing</strong></p>\r\n<p>\r\n	Payments</p>\r\n<ul>\r\n	<li>\r\n		Easy entry of payments and adjustments</li>\r\n	<li>\r\n		Single screen to receive any payment method including cash, check, credit card</li>\r\n	<li>\r\n		Advanced search and filtering to view only the payments you wish to review</li>\r\n	<li>\r\n		Allows receipt from any type of payment source including advance payment, group payment, capitation payment, insurance payment</li>\r\n	<li>\r\n		Easily allocate payment or EOBs to specific encounters</li>\r\n	<li>\r\n		Easily allocate payment to specific CPTs within a claim and track unpaid CPTs within a claim</li>\r\n	<li>\r\n		Ability to enter payments to specific &quot;post to&quot; dates</li>\r\n	<li>\r\n		Easily enter data from EOBs and apply insurance company responses to patient accounts</li>\r\n	<li>\r\n		View and print original EOBs and other payment documents</li>\r\n</ul>\r\n<p>\r\n	ERA&nbsp; Posting</p>\r\n<ul>\r\n	<li>\r\n		Post individual ERA and automatically update to patient accounts</li>\r\n	<li>\r\n		Advanced ability to batch process ERA files from multiple insurance companies greatly reducing process time for larger facilities</li>\r\n</ul>\r\n<p>\r\n	Capitation Payments</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter and track capitation payments</li>\r\n	<li>\r\n		Analysis reporting for profitability of capitated patient encounters</li>\r\n</ul>\r\n<p>\r\n	<strong>Accounts Receivable Management</strong></p>\r\n<ul>\r\n	<li>\r\n		Full featured claims and action tracking allowing to monitor and report on claim status, alert for followups, and identify payer denied claims</li>\r\n	<li>\r\n		Supports claims appeal process to determine reason for denial, collection of needed additional information and resubmission of claim</li>\r\n	<li>\r\n		Maintains call log of followup actions</li>\r\n</ul>\r\n<p>\r\n	<strong>Patient Accounts</strong></p>\r\n<p>\r\n	Pre-Authorization Management</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter pre-autorization and plan details greatly reducing staff time needed to manage the variations of authorized treatment</li>\r\n	<li>\r\n		Track encounters based on number of visits, hours, specific CPTs</li>\r\n	<li>\r\n		Flag encounters where pre-autorization is not covered or reaches allowed coverage</li>\r\n</ul>\r\n<p>\r\n	Patient Ledger</p>\r\n<ul>\r\n	<li>\r\n		Elaborate patient ledger displaying total charges, amounts pending for each insurance, payments received, balance details detailing insurance versus patient portion</li>\r\n	<li>\r\n		Color coded line items to easily distingish services, patient payments, insurance payments, and adjustments</li>\r\n	<li>\r\n		One click viewing of underlying fee sheet or payment</li>\r\n	<li>\r\n		Quick printing directly from ledger of individual patient statement and patient ledger</li>\r\n</ul>\r\n<p>\r\n	Patient Statements</p>\r\n<ul>\r\n	<li>\r\n		Batch or individual printing of billing statements</li>\r\n	<li>\r\n		Quick access to billing statement and payment history from patient profile</li>\r\n	<li>\r\n		Easy billing lookup for responding to patient billing inquiries</li>\r\n</ul>\r\n<p>\r\n	<strong>Advanced Reporting</strong></p>\r\n<ul>\r\n	<li>\r\n		Library of reports to track accounts receivable, patients, and other financial information</li>\r\n	<li>\r\n		Ability to customize reports to needs</li>\r\n	<li>\r\n		Reporting memory option allowing specific filter and reporting queries to be saved for repeated use</li>\r\n	<li>\r\n		Export reports to PDF, Excel or CSV formats</li>\r\n</ul>\r\n', NULL, NULL, 75, 0, NULL, 3, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(982, 254, 15, 30, 'product', 'ZH eRx', '1', '<p>\r\n	ZHOpenEMR&rsquo;s electronic prescription or e-Prescription module enables your practice to facilitate faster delivery of medicines, refills, with accuracy. &nbsp;</p>\r\n<ul>\r\n	<li>\r\n		Submit electronic presriptions to any pharmacy</li>\r\n	<li>\r\n		Supports refill requests</li>\r\n	<li>\r\n		Includes drug-drug and drug-allergy interactions</li>\r\n	<li>\r\n		Allows ability to also print presriptions</li>\r\n	<li>\r\n		Available as a standalone product</li>\r\n</ul>\r\n', NULL, NULL, 35, 0, NULL, 4, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(983, 254, 15, 33, 'support', ' Preferred Support', '1', '<p>\r\n	Our most popular plan provides you with your reliable, always on, always up to date system as well as access to our customer care experts for addressing your technical and ZH OpenEMR software usage questions.</p>\r\n<p>\r\n	Plan Details:</p>\r\n<ul>\r\n	<li>\r\n		$100 per month per provider</li>\r\n	<li>\r\n		Unlimited Support Requests (Incidents)</li>\r\n	<li>\r\n		1 Named Contact&nbsp;&nbsp; &nbsp;&nbsp;</li>\r\n	<li>\r\n		Resolution for ZH -owned issues</li>\r\n	<li>\r\n		Support during Local business hours</li>\r\n	<li>\r\n		12 hour Initial Response Time</li>\r\n	<li>\r\n		Web Case Management</li>\r\n	<li>\r\n		Email Support</li>\r\n	<li>\r\n		One-on-one online support</li>\r\n	<li>\r\n		One-on-one phone support</li>\r\n	<li>\r\n		Remote Troubleshooting&nbsp; &nbsp;&nbsp;</li>\r\n	<li>\r\n		Best practice guidance</li>\r\n	<li>\r\n		Go-Live Assistance</li>\r\n	<li>\r\n		Scheduled Upgrade Assistance</li>\r\n	<li>\r\n		Self Help Support including:&nbsp; &nbsp; &nbsp;&nbsp;\r\n		<ul>\r\n			<li>\r\n				Account Portal</li>\r\n			<li>\r\n				Access to User Manuals</li>\r\n			<li>\r\n				Access to online tutorial videos</li>\r\n			<li>\r\n				Best Practice Knowledge Base</li>\r\n			<li>\r\n				User Forums</li>\r\n		</ul>\r\n	</li>\r\n</ul>\r\n', NULL, NULL, 100, 0, NULL, 7, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(989, 258, 15, 1, 'product', 'ZH OpenEMR', '1', '<p>\r\n	Scheduling</p>\r\n<ul>\r\n	<li>\r\n		Supports multiple physicians and facilities</li>\r\n	<li>\r\n		Easy to manage appointment calendar</li>\r\n	<li>\r\n		Ability to assign olors to easily identify appointment types or facilities</li>\r\n	<li>\r\n		Supports repeating appointments and restricting appointments</li>\r\n	<li>\r\n		Supports patient reminders and notifications</li>\r\n	<li>\r\n		Physcian Reminders</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Patient Demographics</p>\r\n<ul>\r\n	<li>\r\n		Manage Patient Demographics</li>\r\n	<li>\r\n		Comprehensive patient identification profile information, including full name, date of birth, sex, identification, language, ethinicity, marital status</li>\r\n	<li>\r\n		Contact information for patient</li>\r\n	<li>\r\n		Emergency Contact information</li>\r\n	<li>\r\n		Employment Information</li>\r\n	<li>\r\n		Insurance Coverage</li>\r\n	<li>\r\n		Primary Provider</li>\r\n	<li>\r\n		HIPAA Information</li>\r\n	<li>\r\n		Fully Customizable to easily extend out of the box demographic profile</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Patient History</p>\r\n<ul>\r\n	<li>\r\n		Medical Issues</li>\r\n	<li>\r\n		Medications</li>\r\n	<li>\r\n		Immunizations</li>\r\n	<li>\r\n		Vitals</li>\r\n	<li>\r\n		Labs</li>\r\n	<li>\r\n		Procedures</li>\r\n	<li>\r\n		Clinical Decision Rules to check/monitor/alert clinical information (such as vitals, history information, medications, procedures, labs, etc.) in real time</li>\r\n	<li>\r\n		Clinical Measures Calculations</li>\r\n	<li>\r\n		Clinical Quality Measure Calculations</li>\r\n	<li>\r\n		Automated Measure Calculations (AMC) and Tracking</li>\r\n	<li>\r\n		Scan, link, and manage any document or picture</li>\r\n	<li>\r\n		Insurance Eligibility</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Encounters and Charting</p>\r\n<ul>\r\n	<li>\r\n		Fully customizable, template driven forms</li>\r\n	<li>\r\n		Comprehensive chart, visit summary, patient history views for quick updates</li>\r\n	<li>\r\n		Voice recognition ready</li>\r\n	<li>\r\n		Graphical Charting</li>\r\n	<li>\r\n		Easy to use Patient Notes with time savings features allowing saving of frequently used notes for reuse</li>\r\n	<li>\r\n		Diagnosis and procedure coding (CPT/ICD-9)</li>\r\n	<li>\r\n		Communications ready to create letters for insurance providers, referring physicians, or patients</li>\r\n	<li>\r\n		Electronic Syndrome Surveillance reporting</li>\r\n	<li>\r\n		Clinical Measures Calculations</li>\r\n	<li>\r\n		Clinical Quality Measure Calculations</li>\r\n	<li>\r\n		Automated Measure Calculations (AMC) and Tracking</li>\r\n	<li>\r\n		Hardcopy and eRX ready</li>\r\n	<li>\r\n		Paper Chart Tracking</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Billing and Receivables</p>\r\n<ul>\r\n	<li>\r\n		Flexible system of coding including CPT, HCPCS and ICD codes and the ability to add others</li>\r\n	<li>\r\n		Support for electronic billing to clearing houses such as Medavant/Capario and ZirMED using ANSI X12</li>\r\n	<li>\r\n		Support for paper claims</li>\r\n	<li>\r\n		Insurance Eligibility Queries</li>\r\n	<li>\r\n		Insurance Tracking Interface</li>\r\n	<li>\r\n		Accounts Receivable Interface</li>\r\n	<li>\r\n		Medical claim management interface</li>\r\n	<li>\r\n		EOB Entry Interface</li>\r\n	<li>\r\n		Customizable to work with a clearing house for automated 835 or ERA entry</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Additional Features</p>\r\n<ul>\r\n	<li>\r\n		Fully Customizable and Flexible to modify to how you work</li>\r\n	<li>\r\n		Supports use of multiple languages within the same clinic</li>\r\n	<li>\r\n		Robust reporting features with ability to create, enhance, and extend</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Certifications</p>\r\n<ul>\r\n	<li>\r\n		ONC Complete Ambulatory EHR Certified</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	<br />\r\n	Security</p>\r\n<ul>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ability to Encrypt Patient Documents</li>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Supports fine-grained per-user access controls</li>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Remotely accessible from any modern web browser with a suitable security certificate installed</li>\r\n</ul>\r\n', NULL, NULL, 75, 0, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(990, 258, 15, 36, 'product', 'ZH Patient Portal', '1', '<p>\r\n	ZH Patient Portal gives a direct online link between the provider and the patient to allow for easy resolution of questions, make it easier to complete required forms and overall provide a better service to your patients.</p>\r\n<ul>\r\n	<li>\r\n		Flexible and easily configurable to needs of each practice</li>\r\n	<li>\r\n		New patient can register online and complete pre-visit documents</li>\r\n	<li>\r\n		Patient can browse and make appointment online</li>\r\n	<li>\r\n		View and update patient profile inforamtion including demographic and insurance infomation</li>\r\n	<li>\r\n		Make payments online</li>\r\n	<li>\r\n		View medical records including lab results and presriptions</li>\r\n	<li>\r\n		View billing account and statements</li>\r\n	<li>\r\n		Communicate easily through a secure mailbox to request refills, referrals, or other information</li>\r\n</ul>\r\n', NULL, NULL, 0, 0, NULL, 2, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 1, '', 0),
	(991, 258, 15, 29, 'product', 'ZH Advanced Billing', '1', '<p>\r\n	The Advanced Billing module is focused on providing capabilities to manage and improve your revenue cycle by decreasing staff time needed to enter billing, process and manage insurance claims, record payments; improve the accuracy of coding of encounters; provide quick access to patient accounts for responding to inquiries and resolving status of claims.</p>\r\n<p>\r\n	<strong>Enhanced Billing and Claims Processing</strong></p>\r\n<p>\r\n	Smart Fee Sheet</p>\r\n<ul>\r\n	<li>\r\n		Easy to use template that looks like the paper superbill you are used to</li>\r\n	<li>\r\n		Store CPT, ICD valid codes for easy and correct entry</li>\r\n	<li>\r\n		Allows for multiple fee sheets for a single factility</li>\r\n	<li>\r\n		Allows advanced capaility to lock encounters that are not ready for billing</li>\r\n	<li>\r\n		Time saving ability to enter miscellaneous options without leaving the fee sheet</li>\r\n</ul>\r\n<p>\r\n	Batch Charge Entry to Support Larger Facilities</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter multiple claims from a single screen</li>\r\n	<li>\r\n		Allows for entry of new patients from the same screen</li>\r\n</ul>\r\n<p>\r\n	Real Time Eligibility Verification for Insurance</p>\r\n<p>\r\n	Billing Management</p>\r\n<ul>\r\n	<li>\r\n		Work on all claims from a single screen</li>\r\n	<li>\r\n		Advanced filters to see only the claims you are interested in working</li>\r\n	<li>\r\n		Allows to view fee sheet and demographics ledger</li>\r\n	<li>\r\n		Ability to fix all errors before submittal increasing First Pass Rate</li>\r\n	<li>\r\n		Data entry uses quality control verifying codes as you type and automatically applies relevant data (patient, provider, payer) from system database</li>\r\n	<li>\r\n		Generate HCFA, PDF, TXT, or Electronic Claims files</li>\r\n	<li>\r\n		Automatically generate and upload claims to clearing house</li>\r\n	<li>\r\n		Option to direct claims to 3rd party billing systems</li>\r\n	<li>\r\n		Supports multiple insurance company networks</li>\r\n	<li>\r\n		Ability to process secondary insurance claims</li>\r\n	<li>\r\n		Ability to write off balances</li>\r\n	<li>\r\n		Allows for moving balances to patient accounts</li>\r\n	<li>\r\n		Ability to send more than 4 diagnosis with claim</li>\r\n</ul>\r\n<p>\r\n	Clearing House Integration</p>\r\n<ul>\r\n	<li>\r\n		Seamless integration avoiding steps to generate and upload files separately</li>\r\n	<li>\r\n		Advanced import facility will import NPI and Tax ID numbers needed for posting payment from ERA</li>\r\n	<li>\r\n		Enhanced file summary of uploaded claimes to clearing house includes current status of the claims and response from the payer allowing ability to update the EMR database automatically</li>\r\n</ul>\r\n<p>\r\n	Rejected Claim Management</p>\r\n<ul>\r\n	<li>\r\n		Enhanced query ability to enable quick review to remedy errors and refile claims from a sign screen</li>\r\n	<li>\r\n		Stores history relating to why the claims were denied</li>\r\n</ul>\r\n<p>\r\n	<strong>Advanced Payment Receipt Processing</strong></p>\r\n<p>\r\n	Payments</p>\r\n<ul>\r\n	<li>\r\n		Easy entry of payments and adjustments</li>\r\n	<li>\r\n		Single screen to receive any payment method including cash, check, credit card</li>\r\n	<li>\r\n		Advanced search and filtering to view only the payments you wish to review</li>\r\n	<li>\r\n		Allows receipt from any type of payment source including advance payment, group payment, capitation payment, insurance payment</li>\r\n	<li>\r\n		Easily allocate payment or EOBs to specific encounters</li>\r\n	<li>\r\n		Easily allocate payment to specific CPTs within a claim and track unpaid CPTs within a claim</li>\r\n	<li>\r\n		Ability to enter payments to specific &quot;post to&quot; dates</li>\r\n	<li>\r\n		Easily enter data from EOBs and apply insurance company responses to patient accounts</li>\r\n	<li>\r\n		View and print original EOBs and other payment documents</li>\r\n</ul>\r\n<p>\r\n	ERA&nbsp; Posting</p>\r\n<ul>\r\n	<li>\r\n		Post individual ERA and automatically update to patient accounts</li>\r\n	<li>\r\n		Advanced ability to batch process ERA files from multiple insurance companies greatly reducing process time for larger facilities</li>\r\n</ul>\r\n<p>\r\n	Capitation Payments</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter and track capitation payments</li>\r\n	<li>\r\n		Analysis reporting for profitability of capitated patient encounters</li>\r\n</ul>\r\n<p>\r\n	<strong>Accounts Receivable Management</strong></p>\r\n<ul>\r\n	<li>\r\n		Full featured claims and action tracking allowing to monitor and report on claim status, alert for followups, and identify payer denied claims</li>\r\n	<li>\r\n		Supports claims appeal process to determine reason for denial, collection of needed additional information and resubmission of claim</li>\r\n	<li>\r\n		Maintains call log of followup actions</li>\r\n</ul>\r\n<p>\r\n	<strong>Patient Accounts</strong></p>\r\n<p>\r\n	Pre-Authorization Management</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter pre-autorization and plan details greatly reducing staff time needed to manage the variations of authorized treatment</li>\r\n	<li>\r\n		Track encounters based on number of visits, hours, specific CPTs</li>\r\n	<li>\r\n		Flag encounters where pre-autorization is not covered or reaches allowed coverage</li>\r\n</ul>\r\n<p>\r\n	Patient Ledger</p>\r\n<ul>\r\n	<li>\r\n		Elaborate patient ledger displaying total charges, amounts pending for each insurance, payments received, balance details detailing insurance versus patient portion</li>\r\n	<li>\r\n		Color coded line items to easily distingish services, patient payments, insurance payments, and adjustments</li>\r\n	<li>\r\n		One click viewing of underlying fee sheet or payment</li>\r\n	<li>\r\n		Quick printing directly from ledger of individual patient statement and patient ledger</li>\r\n</ul>\r\n<p>\r\n	Patient Statements</p>\r\n<ul>\r\n	<li>\r\n		Batch or individual printing of billing statements</li>\r\n	<li>\r\n		Quick access to billing statement and payment history from patient profile</li>\r\n	<li>\r\n		Easy billing lookup for responding to patient billing inquiries</li>\r\n</ul>\r\n<p>\r\n	<strong>Advanced Reporting</strong></p>\r\n<ul>\r\n	<li>\r\n		Library of reports to track accounts receivable, patients, and other financial information</li>\r\n	<li>\r\n		Ability to customize reports to needs</li>\r\n	<li>\r\n		Reporting memory option allowing specific filter and reporting queries to be saved for repeated use</li>\r\n	<li>\r\n		Export reports to PDF, Excel or CSV formats</li>\r\n</ul>\r\n', NULL, NULL, 75, 0, NULL, 3, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(992, 258, 15, 30, 'product', 'ZH eRx', '1', '<p>\r\n	ZHOpenEMR&rsquo;s electronic prescription or e-Prescription module enables your practice to facilitate faster delivery of medicines, refills, with accuracy. &nbsp;</p>\r\n<ul>\r\n	<li>\r\n		Submit electronic presriptions to any pharmacy</li>\r\n	<li>\r\n		Supports refill requests</li>\r\n	<li>\r\n		Includes drug-drug and drug-allergy interactions</li>\r\n	<li>\r\n		Allows ability to also print presriptions</li>\r\n	<li>\r\n		Available as a standalone product</li>\r\n</ul>\r\n', NULL, NULL, 35, 0, NULL, 4, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(993, 258, 15, 33, 'support', ' Preferred Support', '1', '<p>\r\n	Our most popular plan provides you with your reliable, always on, always up to date system as well as access to our customer care experts for addressing your technical and ZH OpenEMR software usage questions.</p>\r\n<p>\r\n	Plan Details:</p>\r\n<ul>\r\n	<li>\r\n		$100 per month per provider</li>\r\n	<li>\r\n		Unlimited Support Requests (Incidents)</li>\r\n	<li>\r\n		1 Named Contact&nbsp;&nbsp; &nbsp;&nbsp;</li>\r\n	<li>\r\n		Resolution for ZH -owned issues</li>\r\n	<li>\r\n		Support during Local business hours</li>\r\n	<li>\r\n		12 hour Initial Response Time</li>\r\n	<li>\r\n		Web Case Management</li>\r\n	<li>\r\n		Email Support</li>\r\n	<li>\r\n		One-on-one online support</li>\r\n	<li>\r\n		One-on-one phone support</li>\r\n	<li>\r\n		Remote Troubleshooting&nbsp; &nbsp;&nbsp;</li>\r\n	<li>\r\n		Best practice guidance</li>\r\n	<li>\r\n		Go-Live Assistance</li>\r\n	<li>\r\n		Scheduled Upgrade Assistance</li>\r\n	<li>\r\n		Self Help Support including:&nbsp; &nbsp; &nbsp;&nbsp;\r\n		<ul>\r\n			<li>\r\n				Account Portal</li>\r\n			<li>\r\n				Access to User Manuals</li>\r\n			<li>\r\n				Access to online tutorial videos</li>\r\n			<li>\r\n				Best Practice Knowledge Base</li>\r\n			<li>\r\n				User Forums</li>\r\n		</ul>\r\n	</li>\r\n</ul>\r\n', NULL, NULL, 100, 0, NULL, 7, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(994, 259, 15, 1, 'product', 'ZH OpenEMR', '1', '<p>\r\n	Scheduling</p>\r\n<ul>\r\n	<li>\r\n		Supports multiple physicians and facilities</li>\r\n	<li>\r\n		Easy to manage appointment calendar</li>\r\n	<li>\r\n		Ability to assign olors to easily identify appointment types or facilities</li>\r\n	<li>\r\n		Supports repeating appointments and restricting appointments</li>\r\n	<li>\r\n		Supports patient reminders and notifications</li>\r\n	<li>\r\n		Physcian Reminders</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Patient Demographics</p>\r\n<ul>\r\n	<li>\r\n		Manage Patient Demographics</li>\r\n	<li>\r\n		Comprehensive patient identification profile information, including full name, date of birth, sex, identification, language, ethinicity, marital status</li>\r\n	<li>\r\n		Contact information for patient</li>\r\n	<li>\r\n		Emergency Contact information</li>\r\n	<li>\r\n		Employment Information</li>\r\n	<li>\r\n		Insurance Coverage</li>\r\n	<li>\r\n		Primary Provider</li>\r\n	<li>\r\n		HIPAA Information</li>\r\n	<li>\r\n		Fully Customizable to easily extend out of the box demographic profile</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Patient History</p>\r\n<ul>\r\n	<li>\r\n		Medical Issues</li>\r\n	<li>\r\n		Medications</li>\r\n	<li>\r\n		Immunizations</li>\r\n	<li>\r\n		Vitals</li>\r\n	<li>\r\n		Labs</li>\r\n	<li>\r\n		Procedures</li>\r\n	<li>\r\n		Clinical Decision Rules to check/monitor/alert clinical information (such as vitals, history information, medications, procedures, labs, etc.) in real time</li>\r\n	<li>\r\n		Clinical Measures Calculations</li>\r\n	<li>\r\n		Clinical Quality Measure Calculations</li>\r\n	<li>\r\n		Automated Measure Calculations (AMC) and Tracking</li>\r\n	<li>\r\n		Scan, link, and manage any document or picture</li>\r\n	<li>\r\n		Insurance Eligibility</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Encounters and Charting</p>\r\n<ul>\r\n	<li>\r\n		Fully customizable, template driven forms</li>\r\n	<li>\r\n		Comprehensive chart, visit summary, patient history views for quick updates</li>\r\n	<li>\r\n		Voice recognition ready</li>\r\n	<li>\r\n		Graphical Charting</li>\r\n	<li>\r\n		Easy to use Patient Notes with time savings features allowing saving of frequently used notes for reuse</li>\r\n	<li>\r\n		Diagnosis and procedure coding (CPT/ICD-9)</li>\r\n	<li>\r\n		Communications ready to create letters for insurance providers, referring physicians, or patients</li>\r\n	<li>\r\n		Electronic Syndrome Surveillance reporting</li>\r\n	<li>\r\n		Clinical Measures Calculations</li>\r\n	<li>\r\n		Clinical Quality Measure Calculations</li>\r\n	<li>\r\n		Automated Measure Calculations (AMC) and Tracking</li>\r\n	<li>\r\n		Hardcopy and eRX ready</li>\r\n	<li>\r\n		Paper Chart Tracking</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Billing and Receivables</p>\r\n<ul>\r\n	<li>\r\n		Flexible system of coding including CPT, HCPCS and ICD codes and the ability to add others</li>\r\n	<li>\r\n		Support for electronic billing to clearing houses such as Medavant/Capario and ZirMED using ANSI X12</li>\r\n	<li>\r\n		Support for paper claims</li>\r\n	<li>\r\n		Insurance Eligibility Queries</li>\r\n	<li>\r\n		Insurance Tracking Interface</li>\r\n	<li>\r\n		Accounts Receivable Interface</li>\r\n	<li>\r\n		Medical claim management interface</li>\r\n	<li>\r\n		EOB Entry Interface</li>\r\n	<li>\r\n		Customizable to work with a clearing house for automated 835 or ERA entry</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Additional Features</p>\r\n<ul>\r\n	<li>\r\n		Fully Customizable and Flexible to modify to how you work</li>\r\n	<li>\r\n		Supports use of multiple languages within the same clinic</li>\r\n	<li>\r\n		Robust reporting features with ability to create, enhance, and extend</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Certifications</p>\r\n<ul>\r\n	<li>\r\n		ONC Complete Ambulatory EHR Certified</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	<br />\r\n	Security</p>\r\n<ul>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ability to Encrypt Patient Documents</li>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Supports fine-grained per-user access controls</li>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Remotely accessible from any modern web browser with a suitable security certificate installed</li>\r\n</ul>\r\n', NULL, NULL, 75, 0, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(995, 259, 15, 36, 'product', 'ZH Patient Portal', '1', '<p>\r\n	ZH Patient Portal gives a direct online link between the provider and the patient to allow for easy resolution of questions, make it easier to complete required forms and overall provide a better service to your patients.</p>\r\n<ul>\r\n	<li>\r\n		Flexible and easily configurable to needs of each practice</li>\r\n	<li>\r\n		New patient can register online and complete pre-visit documents</li>\r\n	<li>\r\n		Patient can browse and make appointment online</li>\r\n	<li>\r\n		View and update patient profile inforamtion including demographic and insurance infomation</li>\r\n	<li>\r\n		Make payments online</li>\r\n	<li>\r\n		View medical records including lab results and presriptions</li>\r\n	<li>\r\n		View billing account and statements</li>\r\n	<li>\r\n		Communicate easily through a secure mailbox to request refills, referrals, or other information</li>\r\n</ul>\r\n', NULL, NULL, 0, 0, NULL, 2, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 1, '', 0),
	(996, 259, 15, 29, 'product', 'ZH Advanced Billing', '1', '<p>\r\n	The Advanced Billing module is focused on providing capabilities to manage and improve your revenue cycle by decreasing staff time needed to enter billing, process and manage insurance claims, record payments; improve the accuracy of coding of encounters; provide quick access to patient accounts for responding to inquiries and resolving status of claims.</p>\r\n<p>\r\n	<strong>Enhanced Billing and Claims Processing</strong></p>\r\n<p>\r\n	Smart Fee Sheet</p>\r\n<ul>\r\n	<li>\r\n		Easy to use template that looks like the paper superbill you are used to</li>\r\n	<li>\r\n		Store CPT, ICD valid codes for easy and correct entry</li>\r\n	<li>\r\n		Allows for multiple fee sheets for a single factility</li>\r\n	<li>\r\n		Allows advanced capaility to lock encounters that are not ready for billing</li>\r\n	<li>\r\n		Time saving ability to enter miscellaneous options without leaving the fee sheet</li>\r\n</ul>\r\n<p>\r\n	Batch Charge Entry to Support Larger Facilities</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter multiple claims from a single screen</li>\r\n	<li>\r\n		Allows for entry of new patients from the same screen</li>\r\n</ul>\r\n<p>\r\n	Real Time Eligibility Verification for Insurance</p>\r\n<p>\r\n	Billing Management</p>\r\n<ul>\r\n	<li>\r\n		Work on all claims from a single screen</li>\r\n	<li>\r\n		Advanced filters to see only the claims you are interested in working</li>\r\n	<li>\r\n		Allows to view fee sheet and demographics ledger</li>\r\n	<li>\r\n		Ability to fix all errors before submittal increasing First Pass Rate</li>\r\n	<li>\r\n		Data entry uses quality control verifying codes as you type and automatically applies relevant data (patient, provider, payer) from system database</li>\r\n	<li>\r\n		Generate HCFA, PDF, TXT, or Electronic Claims files</li>\r\n	<li>\r\n		Automatically generate and upload claims to clearing house</li>\r\n	<li>\r\n		Option to direct claims to 3rd party billing systems</li>\r\n	<li>\r\n		Supports multiple insurance company networks</li>\r\n	<li>\r\n		Ability to process secondary insurance claims</li>\r\n	<li>\r\n		Ability to write off balances</li>\r\n	<li>\r\n		Allows for moving balances to patient accounts</li>\r\n	<li>\r\n		Ability to send more than 4 diagnosis with claim</li>\r\n</ul>\r\n<p>\r\n	Clearing House Integration</p>\r\n<ul>\r\n	<li>\r\n		Seamless integration avoiding steps to generate and upload files separately</li>\r\n	<li>\r\n		Advanced import facility will import NPI and Tax ID numbers needed for posting payment from ERA</li>\r\n	<li>\r\n		Enhanced file summary of uploaded claimes to clearing house includes current status of the claims and response from the payer allowing ability to update the EMR database automatically</li>\r\n</ul>\r\n<p>\r\n	Rejected Claim Management</p>\r\n<ul>\r\n	<li>\r\n		Enhanced query ability to enable quick review to remedy errors and refile claims from a sign screen</li>\r\n	<li>\r\n		Stores history relating to why the claims were denied</li>\r\n</ul>\r\n<p>\r\n	<strong>Advanced Payment Receipt Processing</strong></p>\r\n<p>\r\n	Payments</p>\r\n<ul>\r\n	<li>\r\n		Easy entry of payments and adjustments</li>\r\n	<li>\r\n		Single screen to receive any payment method including cash, check, credit card</li>\r\n	<li>\r\n		Advanced search and filtering to view only the payments you wish to review</li>\r\n	<li>\r\n		Allows receipt from any type of payment source including advance payment, group payment, capitation payment, insurance payment</li>\r\n	<li>\r\n		Easily allocate payment or EOBs to specific encounters</li>\r\n	<li>\r\n		Easily allocate payment to specific CPTs within a claim and track unpaid CPTs within a claim</li>\r\n	<li>\r\n		Ability to enter payments to specific &quot;post to&quot; dates</li>\r\n	<li>\r\n		Easily enter data from EOBs and apply insurance company responses to patient accounts</li>\r\n	<li>\r\n		View and print original EOBs and other payment documents</li>\r\n</ul>\r\n<p>\r\n	ERA&nbsp; Posting</p>\r\n<ul>\r\n	<li>\r\n		Post individual ERA and automatically update to patient accounts</li>\r\n	<li>\r\n		Advanced ability to batch process ERA files from multiple insurance companies greatly reducing process time for larger facilities</li>\r\n</ul>\r\n<p>\r\n	Capitation Payments</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter and track capitation payments</li>\r\n	<li>\r\n		Analysis reporting for profitability of capitated patient encounters</li>\r\n</ul>\r\n<p>\r\n	<strong>Accounts Receivable Management</strong></p>\r\n<ul>\r\n	<li>\r\n		Full featured claims and action tracking allowing to monitor and report on claim status, alert for followups, and identify payer denied claims</li>\r\n	<li>\r\n		Supports claims appeal process to determine reason for denial, collection of needed additional information and resubmission of claim</li>\r\n	<li>\r\n		Maintains call log of followup actions</li>\r\n</ul>\r\n<p>\r\n	<strong>Patient Accounts</strong></p>\r\n<p>\r\n	Pre-Authorization Management</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter pre-autorization and plan details greatly reducing staff time needed to manage the variations of authorized treatment</li>\r\n	<li>\r\n		Track encounters based on number of visits, hours, specific CPTs</li>\r\n	<li>\r\n		Flag encounters where pre-autorization is not covered or reaches allowed coverage</li>\r\n</ul>\r\n<p>\r\n	Patient Ledger</p>\r\n<ul>\r\n	<li>\r\n		Elaborate patient ledger displaying total charges, amounts pending for each insurance, payments received, balance details detailing insurance versus patient portion</li>\r\n	<li>\r\n		Color coded line items to easily distingish services, patient payments, insurance payments, and adjustments</li>\r\n	<li>\r\n		One click viewing of underlying fee sheet or payment</li>\r\n	<li>\r\n		Quick printing directly from ledger of individual patient statement and patient ledger</li>\r\n</ul>\r\n<p>\r\n	Patient Statements</p>\r\n<ul>\r\n	<li>\r\n		Batch or individual printing of billing statements</li>\r\n	<li>\r\n		Quick access to billing statement and payment history from patient profile</li>\r\n	<li>\r\n		Easy billing lookup for responding to patient billing inquiries</li>\r\n</ul>\r\n<p>\r\n	<strong>Advanced Reporting</strong></p>\r\n<ul>\r\n	<li>\r\n		Library of reports to track accounts receivable, patients, and other financial information</li>\r\n	<li>\r\n		Ability to customize reports to needs</li>\r\n	<li>\r\n		Reporting memory option allowing specific filter and reporting queries to be saved for repeated use</li>\r\n	<li>\r\n		Export reports to PDF, Excel or CSV formats</li>\r\n</ul>\r\n', NULL, NULL, 75, 0, NULL, 3, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(997, 259, 15, 30, 'product', 'ZH eRx', '1', '<p>\r\n	ZHOpenEMR&rsquo;s electronic prescription or e-Prescription module enables your practice to facilitate faster delivery of medicines, refills, with accuracy. &nbsp;</p>\r\n<ul>\r\n	<li>\r\n		Submit electronic presriptions to any pharmacy</li>\r\n	<li>\r\n		Supports refill requests</li>\r\n	<li>\r\n		Includes drug-drug and drug-allergy interactions</li>\r\n	<li>\r\n		Allows ability to also print presriptions</li>\r\n	<li>\r\n		Available as a standalone product</li>\r\n</ul>\r\n', NULL, NULL, 35, 0, NULL, 4, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(998, 259, 15, 33, 'support', ' Preferred Support', '1', '<p>\r\n	Our most popular plan provides you with your reliable, always on, always up to date system as well as access to our customer care experts for addressing your technical and ZH OpenEMR software usage questions.</p>\r\n<p>\r\n	Plan Details:</p>\r\n<ul>\r\n	<li>\r\n		$100 per month per provider</li>\r\n	<li>\r\n		Unlimited Support Requests (Incidents)</li>\r\n	<li>\r\n		1 Named Contact&nbsp;&nbsp; &nbsp;&nbsp;</li>\r\n	<li>\r\n		Resolution for ZH -owned issues</li>\r\n	<li>\r\n		Support during Local business hours</li>\r\n	<li>\r\n		12 hour Initial Response Time</li>\r\n	<li>\r\n		Web Case Management</li>\r\n	<li>\r\n		Email Support</li>\r\n	<li>\r\n		One-on-one online support</li>\r\n	<li>\r\n		One-on-one phone support</li>\r\n	<li>\r\n		Remote Troubleshooting&nbsp; &nbsp;&nbsp;</li>\r\n	<li>\r\n		Best practice guidance</li>\r\n	<li>\r\n		Go-Live Assistance</li>\r\n	<li>\r\n		Scheduled Upgrade Assistance</li>\r\n	<li>\r\n		Self Help Support including:&nbsp; &nbsp; &nbsp;&nbsp;\r\n		<ul>\r\n			<li>\r\n				Account Portal</li>\r\n			<li>\r\n				Access to User Manuals</li>\r\n			<li>\r\n				Access to online tutorial videos</li>\r\n			<li>\r\n				Best Practice Knowledge Base</li>\r\n			<li>\r\n				User Forums</li>\r\n		</ul>\r\n	</li>\r\n</ul>\r\n', NULL, NULL, 100, 0, NULL, 7, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(999, 264, 15, 1, 'product', 'ZH OpenEMR', '1', '<p>\r\n	Scheduling</p>\r\n<ul>\r\n	<li>\r\n		Supports multiple physicians and facilities</li>\r\n	<li>\r\n		Easy to manage appointment calendar</li>\r\n	<li>\r\n		Ability to assign olors to easily identify appointment types or facilities</li>\r\n	<li>\r\n		Supports repeating appointments and restricting appointments</li>\r\n	<li>\r\n		Supports patient reminders and notifications</li>\r\n	<li>\r\n		Physcian Reminders</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Patient Demographics</p>\r\n<ul>\r\n	<li>\r\n		Manage Patient Demographics</li>\r\n	<li>\r\n		Comprehensive patient identification profile information, including full name, date of birth, sex, identification, language, ethinicity, marital status</li>\r\n	<li>\r\n		Contact information for patient</li>\r\n	<li>\r\n		Emergency Contact information</li>\r\n	<li>\r\n		Employment Information</li>\r\n	<li>\r\n		Insurance Coverage</li>\r\n	<li>\r\n		Primary Provider</li>\r\n	<li>\r\n		HIPAA Information</li>\r\n	<li>\r\n		Fully Customizable to easily extend out of the box demographic profile</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Patient History</p>\r\n<ul>\r\n	<li>\r\n		Medical Issues</li>\r\n	<li>\r\n		Medications</li>\r\n	<li>\r\n		Immunizations</li>\r\n	<li>\r\n		Vitals</li>\r\n	<li>\r\n		Labs</li>\r\n	<li>\r\n		Procedures</li>\r\n	<li>\r\n		Clinical Decision Rules to check/monitor/alert clinical information (such as vitals, history information, medications, procedures, labs, etc.) in real time</li>\r\n	<li>\r\n		Clinical Measures Calculations</li>\r\n	<li>\r\n		Clinical Quality Measure Calculations</li>\r\n	<li>\r\n		Automated Measure Calculations (AMC) and Tracking</li>\r\n	<li>\r\n		Scan, link, and manage any document or picture</li>\r\n	<li>\r\n		Insurance Eligibility</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Encounters and Charting</p>\r\n<ul>\r\n	<li>\r\n		Fully customizable, template driven forms</li>\r\n	<li>\r\n		Comprehensive chart, visit summary, patient history views for quick updates</li>\r\n	<li>\r\n		Voice recognition ready</li>\r\n	<li>\r\n		Graphical Charting</li>\r\n	<li>\r\n		Easy to use Patient Notes with time savings features allowing saving of frequently used notes for reuse</li>\r\n	<li>\r\n		Diagnosis and procedure coding (CPT/ICD-9)</li>\r\n	<li>\r\n		Communications ready to create letters for insurance providers, referring physicians, or patients</li>\r\n	<li>\r\n		Electronic Syndrome Surveillance reporting</li>\r\n	<li>\r\n		Clinical Measures Calculations</li>\r\n	<li>\r\n		Clinical Quality Measure Calculations</li>\r\n	<li>\r\n		Automated Measure Calculations (AMC) and Tracking</li>\r\n	<li>\r\n		Hardcopy and eRX ready</li>\r\n	<li>\r\n		Paper Chart Tracking</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Billing and Receivables</p>\r\n<ul>\r\n	<li>\r\n		Flexible system of coding including CPT, HCPCS and ICD codes and the ability to add others</li>\r\n	<li>\r\n		Support for electronic billing to clearing houses such as Medavant/Capario and ZirMED using ANSI X12</li>\r\n	<li>\r\n		Support for paper claims</li>\r\n	<li>\r\n		Insurance Eligibility Queries</li>\r\n	<li>\r\n		Insurance Tracking Interface</li>\r\n	<li>\r\n		Accounts Receivable Interface</li>\r\n	<li>\r\n		Medical claim management interface</li>\r\n	<li>\r\n		EOB Entry Interface</li>\r\n	<li>\r\n		Customizable to work with a clearing house for automated 835 or ERA entry</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Additional Features</p>\r\n<ul>\r\n	<li>\r\n		Fully Customizable and Flexible to modify to how you work</li>\r\n	<li>\r\n		Supports use of multiple languages within the same clinic</li>\r\n	<li>\r\n		Robust reporting features with ability to create, enhance, and extend</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Certifications</p>\r\n<ul>\r\n	<li>\r\n		ONC Complete Ambulatory EHR Certified</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	<br />\r\n	Security</p>\r\n<ul>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ability to Encrypt Patient Documents</li>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Supports fine-grained per-user access controls</li>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Remotely accessible from any modern web browser with a suitable security certificate installed</li>\r\n</ul>\r\n', NULL, NULL, 75, 0, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(1000, 264, 15, 36, 'product', 'ZH Patient Portal', '1', '<p>\r\n	ZH Patient Portal gives a direct online link between the provider and the patient to allow for easy resolution of questions, make it easier to complete required forms and overall provide a better service to your patients.</p>\r\n<ul>\r\n	<li>\r\n		Flexible and easily configurable to needs of each practice</li>\r\n	<li>\r\n		New patient can register online and complete pre-visit documents</li>\r\n	<li>\r\n		Patient can browse and make appointment online</li>\r\n	<li>\r\n		View and update patient profile inforamtion including demographic and insurance infomation</li>\r\n	<li>\r\n		Make payments online</li>\r\n	<li>\r\n		View medical records including lab results and presriptions</li>\r\n	<li>\r\n		View billing account and statements</li>\r\n	<li>\r\n		Communicate easily through a secure mailbox to request refills, referrals, or other information</li>\r\n</ul>\r\n', NULL, NULL, 0, 0, NULL, 2, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 1, '', 0),
	(1001, 264, 15, 29, 'product', 'ZH Advanced Billing', '1', '<p>\r\n	The Advanced Billing module is focused on providing capabilities to manage and improve your revenue cycle by decreasing staff time needed to enter billing, process and manage insurance claims, record payments; improve the accuracy of coding of encounters; provide quick access to patient accounts for responding to inquiries and resolving status of claims.</p>\r\n<p>\r\n	<strong>Enhanced Billing and Claims Processing</strong></p>\r\n<p>\r\n	Smart Fee Sheet</p>\r\n<ul>\r\n	<li>\r\n		Easy to use template that looks like the paper superbill you are used to</li>\r\n	<li>\r\n		Store CPT, ICD valid codes for easy and correct entry</li>\r\n	<li>\r\n		Allows for multiple fee sheets for a single factility</li>\r\n	<li>\r\n		Allows advanced capaility to lock encounters that are not ready for billing</li>\r\n	<li>\r\n		Time saving ability to enter miscellaneous options without leaving the fee sheet</li>\r\n</ul>\r\n<p>\r\n	Batch Charge Entry to Support Larger Facilities</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter multiple claims from a single screen</li>\r\n	<li>\r\n		Allows for entry of new patients from the same screen</li>\r\n</ul>\r\n<p>\r\n	Real Time Eligibility Verification for Insurance</p>\r\n<p>\r\n	Billing Management</p>\r\n<ul>\r\n	<li>\r\n		Work on all claims from a single screen</li>\r\n	<li>\r\n		Advanced filters to see only the claims you are interested in working</li>\r\n	<li>\r\n		Allows to view fee sheet and demographics ledger</li>\r\n	<li>\r\n		Ability to fix all errors before submittal increasing First Pass Rate</li>\r\n	<li>\r\n		Data entry uses quality control verifying codes as you type and automatically applies relevant data (patient, provider, payer) from system database</li>\r\n	<li>\r\n		Generate HCFA, PDF, TXT, or Electronic Claims files</li>\r\n	<li>\r\n		Automatically generate and upload claims to clearing house</li>\r\n	<li>\r\n		Option to direct claims to 3rd party billing systems</li>\r\n	<li>\r\n		Supports multiple insurance company networks</li>\r\n	<li>\r\n		Ability to process secondary insurance claims</li>\r\n	<li>\r\n		Ability to write off balances</li>\r\n	<li>\r\n		Allows for moving balances to patient accounts</li>\r\n	<li>\r\n		Ability to send more than 4 diagnosis with claim</li>\r\n</ul>\r\n<p>\r\n	Clearing House Integration</p>\r\n<ul>\r\n	<li>\r\n		Seamless integration avoiding steps to generate and upload files separately</li>\r\n	<li>\r\n		Advanced import facility will import NPI and Tax ID numbers needed for posting payment from ERA</li>\r\n	<li>\r\n		Enhanced file summary of uploaded claimes to clearing house includes current status of the claims and response from the payer allowing ability to update the EMR database automatically</li>\r\n</ul>\r\n<p>\r\n	Rejected Claim Management</p>\r\n<ul>\r\n	<li>\r\n		Enhanced query ability to enable quick review to remedy errors and refile claims from a sign screen</li>\r\n	<li>\r\n		Stores history relating to why the claims were denied</li>\r\n</ul>\r\n<p>\r\n	<strong>Advanced Payment Receipt Processing</strong></p>\r\n<p>\r\n	Payments</p>\r\n<ul>\r\n	<li>\r\n		Easy entry of payments and adjustments</li>\r\n	<li>\r\n		Single screen to receive any payment method including cash, check, credit card</li>\r\n	<li>\r\n		Advanced search and filtering to view only the payments you wish to review</li>\r\n	<li>\r\n		Allows receipt from any type of payment source including advance payment, group payment, capitation payment, insurance payment</li>\r\n	<li>\r\n		Easily allocate payment or EOBs to specific encounters</li>\r\n	<li>\r\n		Easily allocate payment to specific CPTs within a claim and track unpaid CPTs within a claim</li>\r\n	<li>\r\n		Ability to enter payments to specific &quot;post to&quot; dates</li>\r\n	<li>\r\n		Easily enter data from EOBs and apply insurance company responses to patient accounts</li>\r\n	<li>\r\n		View and print original EOBs and other payment documents</li>\r\n</ul>\r\n<p>\r\n	ERA&nbsp; Posting</p>\r\n<ul>\r\n	<li>\r\n		Post individual ERA and automatically update to patient accounts</li>\r\n	<li>\r\n		Advanced ability to batch process ERA files from multiple insurance companies greatly reducing process time for larger facilities</li>\r\n</ul>\r\n<p>\r\n	Capitation Payments</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter and track capitation payments</li>\r\n	<li>\r\n		Analysis reporting for profitability of capitated patient encounters</li>\r\n</ul>\r\n<p>\r\n	<strong>Accounts Receivable Management</strong></p>\r\n<ul>\r\n	<li>\r\n		Full featured claims and action tracking allowing to monitor and report on claim status, alert for followups, and identify payer denied claims</li>\r\n	<li>\r\n		Supports claims appeal process to determine reason for denial, collection of needed additional information and resubmission of claim</li>\r\n	<li>\r\n		Maintains call log of followup actions</li>\r\n</ul>\r\n<p>\r\n	<strong>Patient Accounts</strong></p>\r\n<p>\r\n	Pre-Authorization Management</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter pre-autorization and plan details greatly reducing staff time needed to manage the variations of authorized treatment</li>\r\n	<li>\r\n		Track encounters based on number of visits, hours, specific CPTs</li>\r\n	<li>\r\n		Flag encounters where pre-autorization is not covered or reaches allowed coverage</li>\r\n</ul>\r\n<p>\r\n	Patient Ledger</p>\r\n<ul>\r\n	<li>\r\n		Elaborate patient ledger displaying total charges, amounts pending for each insurance, payments received, balance details detailing insurance versus patient portion</li>\r\n	<li>\r\n		Color coded line items to easily distingish services, patient payments, insurance payments, and adjustments</li>\r\n	<li>\r\n		One click viewing of underlying fee sheet or payment</li>\r\n	<li>\r\n		Quick printing directly from ledger of individual patient statement and patient ledger</li>\r\n</ul>\r\n<p>\r\n	Patient Statements</p>\r\n<ul>\r\n	<li>\r\n		Batch or individual printing of billing statements</li>\r\n	<li>\r\n		Quick access to billing statement and payment history from patient profile</li>\r\n	<li>\r\n		Easy billing lookup for responding to patient billing inquiries</li>\r\n</ul>\r\n<p>\r\n	<strong>Advanced Reporting</strong></p>\r\n<ul>\r\n	<li>\r\n		Library of reports to track accounts receivable, patients, and other financial information</li>\r\n	<li>\r\n		Ability to customize reports to needs</li>\r\n	<li>\r\n		Reporting memory option allowing specific filter and reporting queries to be saved for repeated use</li>\r\n	<li>\r\n		Export reports to PDF, Excel or CSV formats</li>\r\n</ul>\r\n', NULL, NULL, 75, 0, NULL, 3, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(1002, 264, 15, 30, 'product', 'ZH eRx', '1', '<p>\r\n	ZHOpenEMR&rsquo;s electronic prescription or e-Prescription module enables your practice to facilitate faster delivery of medicines, refills, with accuracy. &nbsp;</p>\r\n<ul>\r\n	<li>\r\n		Submit electronic presriptions to any pharmacy</li>\r\n	<li>\r\n		Supports refill requests</li>\r\n	<li>\r\n		Includes drug-drug and drug-allergy interactions</li>\r\n	<li>\r\n		Allows ability to also print presriptions</li>\r\n	<li>\r\n		Available as a standalone product</li>\r\n</ul>\r\n', NULL, NULL, 35, 0, NULL, 4, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(1003, 264, 15, 33, 'support', ' Preferred Support', '1', '<p>\r\n	Our most popular plan provides you with your reliable, always on, always up to date system as well as access to our customer care experts for addressing your technical and ZH OpenEMR software usage questions.</p>\r\n<p>\r\n	Plan Details:</p>\r\n<ul>\r\n	<li>\r\n		$100 per month per provider</li>\r\n	<li>\r\n		Unlimited Support Requests (Incidents)</li>\r\n	<li>\r\n		1 Named Contact&nbsp;&nbsp; &nbsp;&nbsp;</li>\r\n	<li>\r\n		Resolution for ZH -owned issues</li>\r\n	<li>\r\n		Support during Local business hours</li>\r\n	<li>\r\n		12 hour Initial Response Time</li>\r\n	<li>\r\n		Web Case Management</li>\r\n	<li>\r\n		Email Support</li>\r\n	<li>\r\n		One-on-one online support</li>\r\n	<li>\r\n		One-on-one phone support</li>\r\n	<li>\r\n		Remote Troubleshooting&nbsp; &nbsp;&nbsp;</li>\r\n	<li>\r\n		Best practice guidance</li>\r\n	<li>\r\n		Go-Live Assistance</li>\r\n	<li>\r\n		Scheduled Upgrade Assistance</li>\r\n	<li>\r\n		Self Help Support including:&nbsp; &nbsp; &nbsp;&nbsp;\r\n		<ul>\r\n			<li>\r\n				Account Portal</li>\r\n			<li>\r\n				Access to User Manuals</li>\r\n			<li>\r\n				Access to online tutorial videos</li>\r\n			<li>\r\n				Best Practice Knowledge Base</li>\r\n			<li>\r\n				User Forums</li>\r\n		</ul>\r\n	</li>\r\n</ul>\r\n', NULL, NULL, 100, 0, NULL, 7, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(1004, 272, 15, 1, 'product', 'ZH OpenEMR', '1', '<p>\r\n	Scheduling</p>\r\n<ul>\r\n	<li>\r\n		Supports multiple physicians and facilities</li>\r\n	<li>\r\n		Easy to manage appointment calendar</li>\r\n	<li>\r\n		Ability to assign olors to easily identify appointment types or facilities</li>\r\n	<li>\r\n		Supports repeating appointments and restricting appointments</li>\r\n	<li>\r\n		Supports patient reminders and notifications</li>\r\n	<li>\r\n		Physcian Reminders</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Patient Demographics</p>\r\n<ul>\r\n	<li>\r\n		Manage Patient Demographics</li>\r\n	<li>\r\n		Comprehensive patient identification profile information, including full name, date of birth, sex, identification, language, ethinicity, marital status</li>\r\n	<li>\r\n		Contact information for patient</li>\r\n	<li>\r\n		Emergency Contact information</li>\r\n	<li>\r\n		Employment Information</li>\r\n	<li>\r\n		Insurance Coverage</li>\r\n	<li>\r\n		Primary Provider</li>\r\n	<li>\r\n		HIPAA Information</li>\r\n	<li>\r\n		Fully Customizable to easily extend out of the box demographic profile</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Patient History</p>\r\n<ul>\r\n	<li>\r\n		Medical Issues</li>\r\n	<li>\r\n		Medications</li>\r\n	<li>\r\n		Immunizations</li>\r\n	<li>\r\n		Vitals</li>\r\n	<li>\r\n		Labs</li>\r\n	<li>\r\n		Procedures</li>\r\n	<li>\r\n		Clinical Decision Rules to check/monitor/alert clinical information (such as vitals, history information, medications, procedures, labs, etc.) in real time</li>\r\n	<li>\r\n		Clinical Measures Calculations</li>\r\n	<li>\r\n		Clinical Quality Measure Calculations</li>\r\n	<li>\r\n		Automated Measure Calculations (AMC) and Tracking</li>\r\n	<li>\r\n		Scan, link, and manage any document or picture</li>\r\n	<li>\r\n		Insurance Eligibility</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Encounters and Charting</p>\r\n<ul>\r\n	<li>\r\n		Fully customizable, template driven forms</li>\r\n	<li>\r\n		Comprehensive chart, visit summary, patient history views for quick updates</li>\r\n	<li>\r\n		Voice recognition ready</li>\r\n	<li>\r\n		Graphical Charting</li>\r\n	<li>\r\n		Easy to use Patient Notes with time savings features allowing saving of frequently used notes for reuse</li>\r\n	<li>\r\n		Diagnosis and procedure coding (CPT/ICD-9)</li>\r\n	<li>\r\n		Communications ready to create letters for insurance providers, referring physicians, or patients</li>\r\n	<li>\r\n		Electronic Syndrome Surveillance reporting</li>\r\n	<li>\r\n		Clinical Measures Calculations</li>\r\n	<li>\r\n		Clinical Quality Measure Calculations</li>\r\n	<li>\r\n		Automated Measure Calculations (AMC) and Tracking</li>\r\n	<li>\r\n		Hardcopy and eRX ready</li>\r\n	<li>\r\n		Paper Chart Tracking</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Billing and Receivables</p>\r\n<ul>\r\n	<li>\r\n		Flexible system of coding including CPT, HCPCS and ICD codes and the ability to add others</li>\r\n	<li>\r\n		Support for electronic billing to clearing houses such as Medavant/Capario and ZirMED using ANSI X12</li>\r\n	<li>\r\n		Support for paper claims</li>\r\n	<li>\r\n		Insurance Eligibility Queries</li>\r\n	<li>\r\n		Insurance Tracking Interface</li>\r\n	<li>\r\n		Accounts Receivable Interface</li>\r\n	<li>\r\n		Medical claim management interface</li>\r\n	<li>\r\n		EOB Entry Interface</li>\r\n	<li>\r\n		Customizable to work with a clearing house for automated 835 or ERA entry</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Additional Features</p>\r\n<ul>\r\n	<li>\r\n		Fully Customizable and Flexible to modify to how you work</li>\r\n	<li>\r\n		Supports use of multiple languages within the same clinic</li>\r\n	<li>\r\n		Robust reporting features with ability to create, enhance, and extend</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	Certifications</p>\r\n<ul>\r\n	<li>\r\n		ONC Complete Ambulatory EHR Certified</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	<br />\r\n	Security</p>\r\n<ul>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ability to Encrypt Patient Documents</li>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Supports fine-grained per-user access controls</li>\r\n	<li>\r\n		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Remotely accessible from any modern web browser with a suitable security certificate installed</li>\r\n</ul>\r\n', NULL, NULL, 75, 0, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(1005, 272, 15, 36, 'product', 'ZH Patient Portal', '1', '<p>\r\n	ZH Patient Portal gives a direct online link between the provider and the patient to allow for easy resolution of questions, make it easier to complete required forms and overall provide a better service to your patients.</p>\r\n<ul>\r\n	<li>\r\n		Flexible and easily configurable to needs of each practice</li>\r\n	<li>\r\n		New patient can register online and complete pre-visit documents</li>\r\n	<li>\r\n		Patient can browse and make appointment online</li>\r\n	<li>\r\n		View and update patient profile inforamtion including demographic and insurance infomation</li>\r\n	<li>\r\n		Make payments online</li>\r\n	<li>\r\n		View medical records including lab results and presriptions</li>\r\n	<li>\r\n		View billing account and statements</li>\r\n	<li>\r\n		Communicate easily through a secure mailbox to request refills, referrals, or other information</li>\r\n</ul>\r\n', NULL, NULL, 0, 0, NULL, 2, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 1, '', 0),
	(1006, 272, 15, 29, 'product', 'ZH Advanced Billing', '1', '<p>\r\n	The Advanced Billing module is focused on providing capabilities to manage and improve your revenue cycle by decreasing staff time needed to enter billing, process and manage insurance claims, record payments; improve the accuracy of coding of encounters; provide quick access to patient accounts for responding to inquiries and resolving status of claims.</p>\r\n<p>\r\n	<strong>Enhanced Billing and Claims Processing</strong></p>\r\n<p>\r\n	Smart Fee Sheet</p>\r\n<ul>\r\n	<li>\r\n		Easy to use template that looks like the paper superbill you are used to</li>\r\n	<li>\r\n		Store CPT, ICD valid codes for easy and correct entry</li>\r\n	<li>\r\n		Allows for multiple fee sheets for a single factility</li>\r\n	<li>\r\n		Allows advanced capaility to lock encounters that are not ready for billing</li>\r\n	<li>\r\n		Time saving ability to enter miscellaneous options without leaving the fee sheet</li>\r\n</ul>\r\n<p>\r\n	Batch Charge Entry to Support Larger Facilities</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter multiple claims from a single screen</li>\r\n	<li>\r\n		Allows for entry of new patients from the same screen</li>\r\n</ul>\r\n<p>\r\n	Real Time Eligibility Verification for Insurance</p>\r\n<p>\r\n	Billing Management</p>\r\n<ul>\r\n	<li>\r\n		Work on all claims from a single screen</li>\r\n	<li>\r\n		Advanced filters to see only the claims you are interested in working</li>\r\n	<li>\r\n		Allows to view fee sheet and demographics ledger</li>\r\n	<li>\r\n		Ability to fix all errors before submittal increasing First Pass Rate</li>\r\n	<li>\r\n		Data entry uses quality control verifying codes as you type and automatically applies relevant data (patient, provider, payer) from system database</li>\r\n	<li>\r\n		Generate HCFA, PDF, TXT, or Electronic Claims files</li>\r\n	<li>\r\n		Automatically generate and upload claims to clearing house</li>\r\n	<li>\r\n		Option to direct claims to 3rd party billing systems</li>\r\n	<li>\r\n		Supports multiple insurance company networks</li>\r\n	<li>\r\n		Ability to process secondary insurance claims</li>\r\n	<li>\r\n		Ability to write off balances</li>\r\n	<li>\r\n		Allows for moving balances to patient accounts</li>\r\n	<li>\r\n		Ability to send more than 4 diagnosis with claim</li>\r\n</ul>\r\n<p>\r\n	Clearing House Integration</p>\r\n<ul>\r\n	<li>\r\n		Seamless integration avoiding steps to generate and upload files separately</li>\r\n	<li>\r\n		Advanced import facility will import NPI and Tax ID numbers needed for posting payment from ERA</li>\r\n	<li>\r\n		Enhanced file summary of uploaded claimes to clearing house includes current status of the claims and response from the payer allowing ability to update the EMR database automatically</li>\r\n</ul>\r\n<p>\r\n	Rejected Claim Management</p>\r\n<ul>\r\n	<li>\r\n		Enhanced query ability to enable quick review to remedy errors and refile claims from a sign screen</li>\r\n	<li>\r\n		Stores history relating to why the claims were denied</li>\r\n</ul>\r\n<p>\r\n	<strong>Advanced Payment Receipt Processing</strong></p>\r\n<p>\r\n	Payments</p>\r\n<ul>\r\n	<li>\r\n		Easy entry of payments and adjustments</li>\r\n	<li>\r\n		Single screen to receive any payment method including cash, check, credit card</li>\r\n	<li>\r\n		Advanced search and filtering to view only the payments you wish to review</li>\r\n	<li>\r\n		Allows receipt from any type of payment source including advance payment, group payment, capitation payment, insurance payment</li>\r\n	<li>\r\n		Easily allocate payment or EOBs to specific encounters</li>\r\n	<li>\r\n		Easily allocate payment to specific CPTs within a claim and track unpaid CPTs within a claim</li>\r\n	<li>\r\n		Ability to enter payments to specific &quot;post to&quot; dates</li>\r\n	<li>\r\n		Easily enter data from EOBs and apply insurance company responses to patient accounts</li>\r\n	<li>\r\n		View and print original EOBs and other payment documents</li>\r\n</ul>\r\n<p>\r\n	ERA&nbsp; Posting</p>\r\n<ul>\r\n	<li>\r\n		Post individual ERA and automatically update to patient accounts</li>\r\n	<li>\r\n		Advanced ability to batch process ERA files from multiple insurance companies greatly reducing process time for larger facilities</li>\r\n</ul>\r\n<p>\r\n	Capitation Payments</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter and track capitation payments</li>\r\n	<li>\r\n		Analysis reporting for profitability of capitated patient encounters</li>\r\n</ul>\r\n<p>\r\n	<strong>Accounts Receivable Management</strong></p>\r\n<ul>\r\n	<li>\r\n		Full featured claims and action tracking allowing to monitor and report on claim status, alert for followups, and identify payer denied claims</li>\r\n	<li>\r\n		Supports claims appeal process to determine reason for denial, collection of needed additional information and resubmission of claim</li>\r\n	<li>\r\n		Maintains call log of followup actions</li>\r\n</ul>\r\n<p>\r\n	<strong>Patient Accounts</strong></p>\r\n<p>\r\n	Pre-Authorization Management</p>\r\n<ul>\r\n	<li>\r\n		Ability to enter pre-autorization and plan details greatly reducing staff time needed to manage the variations of authorized treatment</li>\r\n	<li>\r\n		Track encounters based on number of visits, hours, specific CPTs</li>\r\n	<li>\r\n		Flag encounters where pre-autorization is not covered or reaches allowed coverage</li>\r\n</ul>\r\n<p>\r\n	Patient Ledger</p>\r\n<ul>\r\n	<li>\r\n		Elaborate patient ledger displaying total charges, amounts pending for each insurance, payments received, balance details detailing insurance versus patient portion</li>\r\n	<li>\r\n		Color coded line items to easily distingish services, patient payments, insurance payments, and adjustments</li>\r\n	<li>\r\n		One click viewing of underlying fee sheet or payment</li>\r\n	<li>\r\n		Quick printing directly from ledger of individual patient statement and patient ledger</li>\r\n</ul>\r\n<p>\r\n	Patient Statements</p>\r\n<ul>\r\n	<li>\r\n		Batch or individual printing of billing statements</li>\r\n	<li>\r\n		Quick access to billing statement and payment history from patient profile</li>\r\n	<li>\r\n		Easy billing lookup for responding to patient billing inquiries</li>\r\n</ul>\r\n<p>\r\n	<strong>Advanced Reporting</strong></p>\r\n<ul>\r\n	<li>\r\n		Library of reports to track accounts receivable, patients, and other financial information</li>\r\n	<li>\r\n		Ability to customize reports to needs</li>\r\n	<li>\r\n		Reporting memory option allowing specific filter and reporting queries to be saved for repeated use</li>\r\n	<li>\r\n		Export reports to PDF, Excel or CSV formats</li>\r\n</ul>\r\n', NULL, NULL, 75, 0, NULL, 3, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(1007, 272, 15, 30, 'product', 'ZH eRx', '1', '<p>\r\n	ZHOpenEMR&rsquo;s electronic prescription or e-Prescription module enables your practice to facilitate faster delivery of medicines, refills, with accuracy. &nbsp;</p>\r\n<ul>\r\n	<li>\r\n		Submit electronic presriptions to any pharmacy</li>\r\n	<li>\r\n		Supports refill requests</li>\r\n	<li>\r\n		Includes drug-drug and drug-allergy interactions</li>\r\n	<li>\r\n		Allows ability to also print presriptions</li>\r\n	<li>\r\n		Available as a standalone product</li>\r\n</ul>\r\n', NULL, NULL, 35, 0, NULL, 4, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0),
	(1008, 272, 15, 33, 'support', ' Preferred Support', '1', '<p>\r\n	Our most popular plan provides you with your reliable, always on, always up to date system as well as access to our customer care experts for addressing your technical and ZH OpenEMR software usage questions.</p>\r\n<p>\r\n	Plan Details:</p>\r\n<ul>\r\n	<li>\r\n		$100 per month per provider</li>\r\n	<li>\r\n		Unlimited Support Requests (Incidents)</li>\r\n	<li>\r\n		1 Named Contact&nbsp;&nbsp; &nbsp;&nbsp;</li>\r\n	<li>\r\n		Resolution for ZH -owned issues</li>\r\n	<li>\r\n		Support during Local business hours</li>\r\n	<li>\r\n		12 hour Initial Response Time</li>\r\n	<li>\r\n		Web Case Management</li>\r\n	<li>\r\n		Email Support</li>\r\n	<li>\r\n		One-on-one online support</li>\r\n	<li>\r\n		One-on-one phone support</li>\r\n	<li>\r\n		Remote Troubleshooting&nbsp; &nbsp;&nbsp;</li>\r\n	<li>\r\n		Best practice guidance</li>\r\n	<li>\r\n		Go-Live Assistance</li>\r\n	<li>\r\n		Scheduled Upgrade Assistance</li>\r\n	<li>\r\n		Self Help Support including:&nbsp; &nbsp; &nbsp;&nbsp;\r\n		<ul>\r\n			<li>\r\n				Account Portal</li>\r\n			<li>\r\n				Access to User Manuals</li>\r\n			<li>\r\n				Access to online tutorial videos</li>\r\n			<li>\r\n				Best Practice Knowledge Base</li>\r\n			<li>\r\n				User Forums</li>\r\n		</ul>\r\n	</li>\r\n</ul>\r\n', NULL, NULL, 100, 0, NULL, 7, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, 0, '', 0);
...
) ENGINE=InnoDB AUTO_INCREMENT=240 DEFAULT CHARSET=latin1 COMMENT='Customer Selected Plan and its Features';

-- Dumping data for table hosted_emr.customer_selected_plan: ~12 rows (approximately)
...
INSERT INTO `customer_selected_plan` (`idcustomer_selected_plan`, `plan_id`, `plan_name`, `provider_no`, `hf_id`, `dashboard_userid`, `created_date`, `one_time_payment`, `monthly_payment`, `setupfee`, `discount_percentage`, `discount_amount`, `total_payment`, `payment_status`, `payment_date`, `payment_error_message`, `plan_status`, `plan_activated_date`, `plan_disabled_date`, `plan_expired_date`, `plan_deleted_date`, `emr_path`, `mac_ip`, `facility`, `npi`, `license`) VALUES
	...
	(229, 15, 'ZH EMRRevenue', 2, 248, 'asdf@dfdf.com', '2012-07-18', 0, 547.2, 0, 4, 22.8, 547.2, '0', NULL, 'Not Proceed to Payment Gateway', 0, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0),
	(230, 15, 'ZH EMRRevenue', 1, 249, 'hhgg@hhf.com', '2012-07-18', 0, 273.6, 0, 4, 11.4, 273.6, '0', NULL, 'Not Proceed to Payment Gateway', 0, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0),
	(231, 15, 'ZH EMRRevenue', 1, 250, 'cdd@cdd.com', '2012-07-18', 0, 273.6, 0, 4, 11.4, 273.6, '0', NULL, 'Not Proceed to Payment Gateway', 0, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0),
	(232, 15, 'ZH EMRRevenue', 2, 252, 'ddf@ddf.com', '2012-07-18', 0, 547.2, 0, 4, 22.8, 547.2, '0', NULL, 'Not Proceed to Payment Gateway', 0, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0),
	(233, 15, 'ZH EMRRevenue', 2, 253, 'fdfd@fd.com', '2012-07-19', 0, 547.2, 0, 4, 22.8, 547.2, '0', NULL, 'Not Proceed to Payment Gateway', 0, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0),
	(234, 15, 'ZH EMRRevenue', 2, 254, 'adsf@asdf.com', '2012-07-19', 0, 547.2, 0, 4, 22.8, 547.2, '0', NULL, 'Not Proceed to Payment Gateway', 0, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0),
	(236, 15, 'ZH EMRRevenue', 2, 258, 'nh@nhh.com', '2012-07-20', 0, 547.2, 0, 4, 22.8, 547.2, '0', NULL, 'Not Proceed to Payment Gateway', 0, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0),
	(237, 15, 'ZH EMRRevenue', 2, 259, 'aasa@aadb.com', '2012-07-20', 0, 547.2, 0, 4, 22.8, 547.2, '0', NULL, 'Not Proceed to Payment Gateway', 0, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0),
	(238, 15, 'ZH EMRRevenue', 2, 264, 'dsd@dsd.com', '2012-07-23', 0, 547.2, 0, 4, 22.8, 547.2, '0', NULL, 'Not Proceed to Payment Gateway', 0, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0),
	(239, 15, 'ZH EMRRevenue', 2, 272, 'bgbg@bg.com', '2012-07-23', 0, 547.2, 0, 4, 22.8, 547.2, '0', NULL, 'Not Proceed to Payment Gateway', 0, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0);
/*!40000 ALTER TABLE `customer_selected_plan` ENABLE KEYS */;


-- Dumping structure for table hosted_emr.db_server
...
CREATE TABLE IF NOT EXISTS `db_server` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `db_name` (`db_name`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=latin1 COMMENT='Database Server Master Table';

-- Dumping data for table hosted_emr.db_server: 1 rows
DELETE FROM `db_server`;
/*!40000 ALTER TABLE `db_server` DISABLE KEYS */;
INSERT INTO `db_server` (`id`, `db_name`, `status`) VALUES
	(5, 'http://hostedopenemr.com', 1);
...
CREATE TABLE IF NOT EXISTS `faq` (
  ...
  PRIMARY KEY (`faqid`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1 COMMENT='FAQ Section';

-- Dumping data for table hosted_emr.faq: ~1 rows (approximately)
DELETE FROM `faq`;
...
-- Dumping data for table hosted_emr.hosted_facilities: ~26 rows (approximately)
...
INSERT INTO `hosted_facilities` (`hf_id`, `customer_id`, `hf_organization`, `hf_facility_identifier`, `hf_facility_suffix`, `hf_facility_name`, `hf_facility_lname`, `hf_speciality`, `dashboard_password`, `hf_email`, `hf_phone`, `hf_address`, `hf_fax`, `hf_city`, `hf_zip`, `hf_state`, `hf_tax_id`, `hf_country`, `hf_npi`, `reg_date`, `user_status`, `hosted_server`, `db_server`, `backup_db_server`, `hf_backup_password`, `temp_password`, `temp_password_date`) VALUES
	...
	(248, 1, 'asdf', 'asdf', 'Dr.', 'asdf', 'asdf', 'Allergy and Immunology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'asdf@dfdf.com', '234', 'adsf', '0', 'asdf', '234', 'Alabama', '0', 'USA', '0', '2012-07-18', 1, NULL, '', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00'),
	(249, 1, 'hhgg', 'hhgg', 'Dr.', 'hhgg', 'hhgg', 'Allergy and Immunology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'hhgg@hhf.com', '654', 'asdf', '0', 'asdf', '564', 'Alabama', '0', 'USA', '0', '2012-07-18', 1, NULL, '', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00'),
	(250, 1, 'cdcd', 'cdcd', 'Dr.', 'cd', 'cd', 'Allergy and Immunology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'cdd@cdd.com', '234', 'sadf', '0', 'asdf', '234', 'Alabama', '0', 'USA', '0', '2012-07-18', 1, NULL, '', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00'),
	(251, 1, 'ghgh', 'ghgh', 'Dr.', 'ghgh', 'ghgh', 'Allergy and Immunology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'ghgh@df.comn', '546', 'asdf', '0', 'asdf', '465', 'Alabama', '0', 'USA', '0', '2012-07-18', 1, NULL, '', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00'),
	(252, 1, 'ddf', 'ddf', 'Dr.', 'ddf', 'ddf', 'Allergy and Immunology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'ddf@ddf.com', '654', 'adsf', '0', 'asdf', '546', 'Alabama', '0', 'USA', '0', '2012-07-18', 1, NULL, '', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00'),
	(253, 1, 'fdfd', 'fdfd', 'Dr.', 'fdfd', 'fdfd', 'Pathology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'fdfd@fd.com', '654', 'sadf', '0', 'sadf', '645', 'Alabama', '0', 'USA', '0', '2012-07-19', 1, 'asdf', 'asdf', 'sdsd', 'backup.hostedopenemr', '', '0000-00-00'),
	(254, 1, 'asdf', 'asdfd', 'Dr.', 'df', 'df', 'Paediatric infectious diseases', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'adsf@asdf.com', '23423', 'asdf', '0', 'asdf', '34234', 'Alabama', '0', 'USA', '0', '2012-07-19', 1, 'http://hostedopenemr.com', 'http://hostedopenemr.com', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00'),
	(255, 1, 'vf', 'vf', 'Dr.', 'vf', 'vf', 'Allergy and Immunology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'vf@vf.com', '654', 'asdf', '0', 'sadf', '654', 'Alabama', '0', 'USA', '0', '2012-07-20', 1, 'http://hostedopenemr.com', 'http://hostedopenemr.com', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00'),
	(256, 1, 'df', 'df', 'Dr.', 'df', 'df', 'Allergy and Immunology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'df@df.com', '654', 'asdf', '0', 'asdf', '654', 'Alabama', '0', 'USA', '0', '2012-07-20', 1, 'http://hostedopenemr.com', 'http://hostedopenemr.com', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00'),
	(257, 1, 'nh', 'nh', 'Dr.', 'nh', 'nh', 'Allergy and Immunology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'nh@nh.com', '564', 'asdf', '0', 'sadf', '654', 'Alabama', '0', 'USA', '0', '2012-07-20', 1, 'http://hostedopenemr.com', 'http://hostedopenemr.com', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00'),
	(258, 1, 'nh', 'nhh', 'Dr.', 'nhh', 'nhh', 'Allergy and Immunology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'nh@nhh.com', '564', 'asdf', '0', 'sadf', '654', 'Alabama', '0', 'USA', '0', '2012-07-20', 1, 'http://hostedopenemr.com', 'http://hostedopenemr.com', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00'),
	(259, 1, 'aasa', 'aasa', 'Dr.', 'aa', 'aa', 'Allergy and Immunology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'aasa@aadb.com', '654', 'asdf', '0', 'sadf', '654', 'Alabama', '0', 'USA', '0', '2012-07-20', 1, 'http://hostedopenemr.com', 'http://hostedopenemr.com', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00'),
	(260, 1, 'apk', 'apk', 'Dr.', 'apk', 'apk', 'Allergy and Immunology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'apk@apk.com', '654', 'asdf', '0', 'asdf', '654', 'Alabama', '0', 'USA', '0', '2012-07-23', 1, 'http://hostedopenemr.com', 'http://hostedopenemr.com', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00'),
	(261, 1, 'aasdaa', 'asdfd', 'Dr.', 'asdf', 'asdf', 'Allergy and Immunology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'asdf@asdff.com', '654', 'asdf', '0', 'asdf', '654', 'Alabama', '0', 'USA', '0', '2012-07-23', 1, 'http://hostedopenemr.com', 'http://hostedopenemr.com', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00'),
	(262, 1, 'bvb', 'vbv', 'Dr.', 'bvb', 'vbv', 'Allergy and Immunology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'bvb@bvb.com', '654', 'sadf', '0', 'asdf', '654', 'Alabama', '0', 'USA', '0', '2012-07-23', 1, 'http://hostedopenemr.com', 'http://hostedopenemr.com', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00'),
	(263, 1, 'cvc', 'cvc', 'Dr.', 'cvc', 'cvc', 'Allergy and Immunology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'cvc@asd.com', '654', 'asdf', '0', 'asdf', '654', 'Alabama', '0', 'USA', '0', '2012-07-23', 1, 'http://hostedopenemr.com', 'http://hostedopenemr.com', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00'),
	(264, 1, 'dsd', 'dsd', 'Dr.', 'dsd', 'dsd', 'Allergy and Immunology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'dsd@dsd.com', '655', 'asdf', '0', 'asdf', '654', 'Alabama', '0', 'USA', '0', '2012-07-23', 1, 'http://hostedopenemr.com', 'http://hostedopenemr.com', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00'),
	(265, 1, 'hgh', 'ghg', 'Dr.', 'ghg', 'ghg', 'Allergy and Immunology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'ghg@sdf.com', '654', 'asdf', '0', 'asdf', '564', 'Alabama', '0', 'USA', '0', '2012-07-23', 1, 'http://hostedopenemr.com', 'http://hostedopenemr.com', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00'),
	(266, 1, 'ghjhg', 'gfhjfgh', 'Dr.', 'fghjfgh', 'gfhjfgh', 'Allergy and Immunology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'fghj@asdf.com', '654', 'asdf', '0', 'asdf', '564', 'Alabama', '0', 'USA', '0', '2012-07-23', 1, 'http://hostedopenemr.com', 'http://hostedopenemr.com', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00'),
	(267, 1, 'ghjhg', 'gfhjfgh', 'Dr.', 'fghjfgh', 'gfhjfgh', 'Allergy and Immunology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'fghjs@asdf.com', '654', 'asdf', '0', 'asdf', '564', 'Alabama', '0', 'USA', '0', '2012-07-23', 1, 'http://hostedopenemr.com', 'http://hostedopenemr.com', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00'),
	(268, 1, 'aaza', 'aaza', 'Dr.', 'aaza', 'aaza', 'Allergy and Immunology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'aaza@aa.com', '654', 'asdf', '0', 'asdf', '654', 'Alabama', '0', 'USA', '0', '2012-07-23', 1, 'http://hostedopenemr.com', 'http://hostedopenemr.com', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00'),
	(269, 1, 'dfdf', 'dfdf', 'Dr.', 'dfdf', 'dfdf', 'Allergy and Immunology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'dfdf@dfdf.com', '654', 'afsd', '0', 'asdf', '654', 'Alabama', '0', 'USA', '0', '2012-07-23', 1, 'http://hostedopenemr.com', 'http://hostedopenemr.com', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00'),
	(270, 1, 'dds', 'dds', 'Dr.', 'dds', 'dds', 'Allergy and Immunology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'dds@dds.com', '654', 'asdf', '0', 'asdf', '654', 'Alabama', '0', 'USA', '0', '2012-07-23', 1, 'http://hostedopenemr.com', 'http://hostedopenemr.com', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00'),
	(271, 1, 'xxs', 'xxs', 'Dr.', 'xxs', 'xxs', 'Allergy and Immunology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'xxs@sd.com', '654', 'asdf', '0', 'asdf', '564', 'Alabama', '0', 'USA', '0', '2012-07-23', 1, 'http://hostedopenemr.com', 'http://hostedopenemr.com', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00'),
	(272, 1, 'bgbg', 'bgbg', 'Dr.', 'bg', 'bg', 'Allergy and Immunology', '82b37cf1fbcaa4e6b1e7b5134f62be1c7383e3c1', 'bgbg@bg.com', '45', 'asdf', '0', 'asdf', '65', 'Alabama', '0', 'USA', '0', '2012-07-23', 1, 'http://hostedopenemr.com', 'http://hostedopenemr.com', 'backup.hostedopenemr', 'backup.hostedopenemr', '', '0000-00-00');
...
-- Dumping data for table hosted_emr.messages: ~61 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `modules` (
  ...
  `menu_group` varchar(50) NOT NULL DEFAULT '0',
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=latin1 COMMENT='Main Module Table (ACL)';

-- Dumping data for table hosted_emr.modules: ~13 rows (approximately)
DELETE FROM `modules`;
/*!40000 ALTER TABLE `modules` DISABLE KEYS */;
INSERT INTO `modules` (`module_id`, `menu_group`, `module_name`, `module_controller`, `module_display_name`, `customer_id`) VALUES
	(1, 'Plan', 'Admin', 'Plans', 'Plans', 1),
	(2, 'Plan', 'Admin', 'Products', 'Products', 1),
	(3, 'Help', 'Admin', 'Help', 'Help (Tips)', 1),
	(4, 'Help', 'Admin', 'PageHelp', 'Page Wise Help', 1),
	(5, 'Users', 'Admin', 'Users', 'Registered Customers', 1),
	(6, '', 'Admin', 'Acl', 'Acl Module', 1),
	(7, 'CMS', 'Admin', 'Cms', 'Cms', 1),
	(8, 'Setting', 'Admin', 'EmailTemplate', 'Email Templates', 1),
	(9, 'Setting', 'Admin', 'Speciality', 'Speciality', 1),
	(10, 'CMS', 'Admin', 'Faq', ' F A Q', 1),
	(11, 'Setting', 'Admin', 'Paypal', 'Paypal Setting', 1),
	(12, 'Setting', 'Admin', 'DBserver', 'DB Server', 1),
	(13, 'Setting', 'Admin', 'Bkpdbserver', 'Backup Server Details', 1);
...
-- Dumping structure for table hosted_emr.notusing_unit
DROP TABLE IF EXISTS `notusing_unit`;
CREATE TABLE IF NOT EXISTS `notusing_unit` (
  `Code` char(3) NOT NULL DEFAULT '',
  `Name` char(52) NOT NULL DEFAULT '',
  `Continent` enum('Asia','Europe','North America','Africa','Oceania','Antarctica','South America') NOT NULL DEFAULT 'Asia',
  `Region` char(26) NOT NULL DEFAULT '',
...
-- Dumping data for table hosted_emr.notusing_unit: 237 rows
DELETE FROM `notusing_unit`;
/*!40000 ALTER TABLE `notusing_unit` DISABLE KEYS */;
INSERT INTO `notusing_unit` (`Code`, `Name`, `Continent`, `Region`, `SurfaceArea`, `IndepYear`, `Population`, `LifeExpectancy`, `GNP`, `GNPOld`, `LocalName`, `GovernmentForm`, `HeadOfState`, `Capital`, `Code2`) VALUES
	('AFG', 'Afghanistan', 'Asia', 'Southern and Central Asia', 652090.00, 1919, 22720000, 45.9, 5976.00, NULL, 'Afganistan/Afqanestan', 'Islamic Emirate', 'Mohammad Omar', 1, 'AF'),
	('ALB', 'Albania', 'Europe', 'Southern Europe', 28748.00, 1912, 3401200, 71.6, 3205.00, 2500.00, 'ShqipÃƒÂ«ria', 'Republic', 'Rexhep Mejdani', 34, 'AL'),
	('DZA', 'Algeria', 'Africa', 'Northern Africa', 2381741.00, 1962, 31471000, 69.7, 49982.00, 46966.00, 'Al-JazaÃ¢â‚¬â„¢ir/AlgÃƒÂ©rie', 'Republic', 'Abdelaziz Bouteflika', 35, 'DZ'),
	('ASM', 'American Samoa', 'Oceania', 'Polynesia', 199.00, NULL, 68000, 75.1, 334.00, NULL, 'Amerika Samoa', 'US Territory', 'George W. Bush', 54, 'AS'),
	...
	('ATF', 'French Southern territories', 'Antarctica', 'Antarctica', 7780.00, NULL, 0, NULL, 0.00, NULL, 'Terres australes franÃƒÂ§aises', 'Nonmetropolitan Territory of France', 'Jacques Chirac', NULL, 'TF'),
	('UMI', 'United States Minor Outlying Islands', 'Oceania', 'Micronesia/Caribbean', 16.00, NULL, 0, NULL, 0.00, NULL, 'United States Minor Outlying Islands', 'Dependent Territory of the US', 'George W. Bush', NULL, 'UM');
/*!40000 ALTER TABLE `notusing_unit` ENABLE KEYS */;
...
-- Dumping data for table hosted_emr.products: ~9 rows (approximately)
