...
CREATE TABLE IF NOT EXISTS `acl_user_setting` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=143 DEFAULT CHARSET=latin1 COMMENT='Controller and Action Section for a user';

-- Dumping data for table hosted_emr.acl_user_setting: ~70 rows (approximately)
...
-- Dumping data for table hosted_emr.autonumber: ~61 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `cart` (
  ...
  PRIMARY KEY (`idcart`)
) ENGINE=InnoDB AUTO_INCREMENT=463 DEFAULT CHARSET=latin1 COMMENT='Shopping Cart';

-- Dumping data for table hosted_emr.cart: ~15 rows (approximately)
DELETE FROM `cart`;
...
INSERT INTO `cart` (`idcart`, `cartsession`, `plan_id`, `product_id`, `hf_id`, `description`, `qty_from`, `qty`, `unit_price`, `setupfee`, `discount`, `setupfee_discount`, `total`, `cstatus`, `cart_date`, `invoice_no`) VALUES
	(434, 'niq0on43d0q1l9jg2fdchvk451', 15, 0, 246, 'ZH EMRRevenue Subscription', 0, 2, 570, 0, 70, 0, 500, 0, '2012-07-02', NULL),
	(441, 'bv969a0psc1u89998gntcs8en1', 15, 0, 247, 'ZH EMRRevenue Subscription', 0, 3, 855, 0, 105, 0, 750, 0, '2012-07-02', NULL),
...
-- Dumping data for table hosted_emr.cms: ~18 rows (approximately)
DELETE FROM `cms`;
...
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=latin1 COMMENT='Invoice Details of Customers';
...
INSERT INTO `customer_invoice` (`idcustomer_invoice`, `plan_id`, `hf_id`, `invoice_number`, `cartsessionid`, `particulars`, `amount`, `setupfee`, `payment_date`, `payment_status`, `transaction_id`, `status_message`, `invoice_date`, `paypal_string`, `subscription_amount`, `subscr_id`, `discount_percentage`, `discount_amount`, `activation_status`, `activation_message`) VALUES
	(35, 15, 253, 'ZH-2012-07-03-00035', 'hst2k708icnlpm4v9j47tif5c5', 'ZH EMRRevenue Subscription,Concierge Support', 700, 0, '2012-07-03', 'COMPLETED', '7TF28916S0761061D', 'Pending', '2012-07-03', '{"PROFILEID":"I-W0GUX4YCD66L","TRANSACTIONID":"7TF28916S0761061D","TIMESTAMP":"2012-07-03T05:51:28Z","CORRELATIONID":"744ab9a1be8fc","ACK":"Success","VERSION":"51.0","BUILD":"3231178"}', 700, 'I-W0GUX4YCD66L', 0, 70, 0, NULL),
	(36, 15, 254, 'ZH-2012-07-03-00036', 'hst2k708icnlpm4v9j47tif5c5', 'ZH EMRRevenue Subscription,Concierge Support', 700, 0, NULL, 'Pending', '0', 'Pending', '2012-07-03', NULL, 700, NULL, 0, 70, 0, NULL),
	(37, 15, 256, 'ZH-2012-07-03-00037', 'adj3jt1m2kp33r1j7ddcfdmrf2', 'ZH EMRRevenue Subscription,Concierge Support', 1050, 0, '2012-07-03', 'COMPLETED', '18P4640060886653Y', 'Pending', '2012-07-03', '{"PROFILEID":"I-UTVS06N1KWWF","TRANSACTIONID":"18P4640060886653Y","TIMESTAMP":"2012-07-03T06:04:29Z","CORRELATIONID":"382fdc65240b3","ACK":"Success","VERSION":"51.0","BUILD":"3231178"}', 1050, 'I-UTVS06N1KWWF', 0, 105, 0, NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=856 DEFAULT CHARSET=latin1 COMMENT='Products Master Table';

-- Dumping data for table hosted_emr.customer_products: ~22 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=201 DEFAULT CHARSET=latin1 COMMENT='Customer Selected Plan and its Features';

-- Dumping data for table hosted_emr.customer_selected_plan: ~4 rows (approximately)
...
INSERT INTO `customer_selected_plan` (`idcustomer_selected_plan`, `plan_id`, `plan_name`, `provider_no`, `hf_id`, `dashboard_userid`, `created_date`, `one_time_payment`, `monthly_payment`, `setupfee`, `discount_percentage`, `discount_amount`, `total_payment`, `payment_status`, `payment_date`, `payment_error_message`, `plan_status`, `plan_activated_date`, `plan_disabled_date`, `plan_expired_date`, `plan_deleted_date`, `emr_path`, `mac_ip`, `facility`, `npi`, `license`) VALUES
	(197, 15, 'ZH EMRRevenue', 2, 253, 'bv@bv.com', '2012-07-03', 0, 300, 0, 35, 70, 300, '0', NULL, 'Not Proceed to Payment Gateway', 0, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0),
	(198, 15, 'ZH EMRRevenue', 2, 254, 'nb@nb.com', '2012-07-03', 0, 300, 0, 35, 70, 300, 'COMPLETED', '2012-07-03', '', 1, '2012-07-03', NULL, NULL, NULL, NULL, 1, NULL, NULL, 0),
	(199, 15, 'ZH EMRRevenue', 3, 255, 'mn@mn.com', '2012-07-03', 0, 750, 0, 35, 105, 750, '0', NULL, 'Not Proceed to Payment Gateway', 0, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0),
	(200, 15, 'ZH EMRRevenue', 3, 256, 'km@km.com', '2012-07-03', 0, 450, 0, 35, 105, 450, 'COMPLETED', '2012-07-03', '', 1, '2012-07-03', NULL, NULL, NULL, NULL, 1, NULL, NULL, 0);
...
-- Dumping data for table hosted_emr.hosted_facilities: ~11 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `messages` (
  ...
  `date` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=latin1 COMMENT='Internam Message Section';

-- Dumping data for table hosted_emr.messages: ~42 rows (approximately)
